...
public interface IPackageSubTranslator {
   ...
   */
  PaginationBaseResponseModel<PackageResponseModel> getPackagesInBatches(
   ...
   *
   * <p>This method processes packages in a background thread with the following characteristics: -
   * Supports partial success: if some packages fail validation, others still succeed - Sends
   * detailed results to user via message notification after processing completes
   *
