 ...
 * 
 * This interface defines the contract for QA-related operations including
 * endpoint-to-test mapping, coverage statistics, service discovery, and test run tracking.
 * 
...
public interface IQASubTranslator {
    ...
    /**
     * Starts an async test execution.
     * Returns immediately with status object containing executionId for polling.
     * 
     * @param request The test execution request (determines scope: all, service, method, or specific tests)
