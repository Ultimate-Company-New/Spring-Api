 ...
 * 
 * This interface defines the contract for all product review-related business operations
...
public interface IProductReviewSubTranslator {
     ...
     * @throws UnauthorizedException if user is not authorized
     */
    PaginationBaseResponseModel<ProductReviewResponseModel> getProductReviewsInBatchesGivenProductId(PaginationBaseRequestModel paginationBaseRequestModel, long id);
