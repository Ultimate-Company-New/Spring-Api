 ...
 *
 * <p>This interface defines the contract for user management operations including CRUD operations,
 * user retrieval, and user status management. All implementations should handle proper validation,
...
public interface IUserSubTranslator {
   ...
   * UserResponseModel contains all user details.
   *
   ...
   * the database. The method automatically sets audit fields such as createdUser, modifiedUser, and
   * timestamps.
   *
   ...
   *     batch.
   */
  PaginationBaseResponseModel<UserResponseModel> fetchUsersInCarrierInBatches(
   ...
   * user's stored token 3. Sets emailConfirmed to true
   *
