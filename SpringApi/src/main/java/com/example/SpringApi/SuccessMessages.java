...
public class SuccessMessages {
    ...
    public static class LoginSuccessMessages {
        ...
        // standard success messages
        public static final String USER_EMAIL_CONFIRMED = "User Email confirmed please log in to the platform to continue using the application.";
    ...
    public static class PurchaseOrderSuccessMessages {
        ...
        public static final String GET_PURCHASE_ORDER = "Successfully retrieved purchase order details.";
        public static final String TOGGLE_PURCHASE_ORDER = "Successfully toggled purchase order.";
        public static final String SET_APPROVED_BY_PURCHASE_ORDER = "Successfully updated the approved by user id for the given purchase order.";
        public static final String SET_REJECTED_BY_PURCHASE_ORDER = "Successfully updated the rejected by user id for the given purchase order.";
        public static final String GET_PURCHASE_ORDER_PDF = "Successfully retrieved purchase order pdf.";
    }
    ...
    public static class UserGridPreferenceSuccessMessages {
        ...
        // standard success messages
        public static final String UPDATE_USER_GRID_PREFERENCE = "Successfully updated user grid preferences.";
