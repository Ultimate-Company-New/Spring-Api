...
/**
 * Standard JPA Repository for User entity.
 * Uses @Query annotations for custom queries.
 * 
 * For multi-filter queries, use UserFilterQueryBuilder directly from the service layer.
 */
@Repository
