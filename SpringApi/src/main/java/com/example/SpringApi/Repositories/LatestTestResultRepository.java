...
/**
 * Repository for LatestTestResult entity.
 * Provides methods for querying the latest test results summary.
 */
@Repository
public interface LatestTestResultRepository extends JpaRepository<LatestTestResult, Long> {
        ...
        */
       List<LatestTestResult> findByClientIdAndServiceNameOrderByTestMethodNameAsc(Long clientId, String serviceName);
        ...
        */
       @Query("SELECT ltr FROM LatestTestResult ltr WHERE ltr.clientId = :clientId " +
        ...
        */
       @Query("SELECT ltr.status, COUNT(ltr) FROM LatestTestResult ltr WHERE ltr.clientId = :clientId " +
                     "GROUP BY ltr.status")
        ...
        */
       @Query("SELECT ltr.status, COUNT(ltr) FROM LatestTestResult ltr " +
        ...
        */
       List<LatestTestResult> findByClientIdAndLastRunByUserIdOrderByLastRunAtDesc(Long clientId, Long userId);
