...
public interface ProductReviewRepository extends JpaRepository<ProductReview, Long> {
    ...
    @Query("SELECT pr FROM ProductReview pr " +
           ...
           "ELSE '' END))")
    Page<ProductReview> findPaginatedProductReviews(@Param("clientId") Long clientId,
    ...
    ProductReview findByReviewIdAndClientId(@Param("reviewId") Long reviewId, @Param("clientId") Long clientId);
