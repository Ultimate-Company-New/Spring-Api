...
public interface PurchaseOrderRepository extends JpaRepository<PurchaseOrder, Long> {
     ...
     * - Client
     * 
     * Note: Address and financial details are now stored in OrderSummary (linked via entityType/entityId).
     * Products and shipments are stored in ShipmentProduct and related tables (linked via OrderSummary).
     * 
     * @param purchaseOrderId The purchase order ID
     * @param clientId The client ID
