...
public class EmailTemplates {
  ...
  public boolean sendImportBulkDataResults(
    ...
    String logoHtml =
        (companyLogoUrl != null && !companyLogoUrl.isEmpty())
            ? String.format(
                "<img src=\"%s\" alt=\"Company Logo\" style=\"width: 300px; height: 200px; margin-bottom: 20px;\">",
                companyLogoUrl)
            : "";
  ...
  public boolean sendNewUserAccountConfirmation(
    ...
    String logoHtml =
        (companyLogoUrl != null && !companyLogoUrl.isEmpty())
            ? String.format(
                "<img src=\"%s\" alt=\"%s Logo\" style=\"width: 300px; height: 200px; margin-bottom: 20px;\">",
  ...
  public boolean sendMessageEmail(
    ...
    String logoHtml =
        (companyLogoUrl != null && !companyLogoUrl.isEmpty())
            ? String.format(
                "<img src=\"%s\" alt=\"%s Logo\" style=\"max-width: 300px; height: auto; margin-bottom: 20px;\">",
                companyLogoUrl, client.getName())
            : "";
