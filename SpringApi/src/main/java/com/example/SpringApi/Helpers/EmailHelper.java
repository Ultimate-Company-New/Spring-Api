...
public class EmailHelper implements IEmailHelper {
    ...
    public boolean sendEmail(SendEmailRequest request) {
        ...
        try {
            ...
            throw new BadRequestException(ErrorMessages.EmailErrorMessages.ER001 + ": " + sendGridResponse.getBody());
        } catch (IOException e) {
    ...
    public String generateBatchId() {
        ...
        try{
            ...
            throw new BadRequestException(ErrorMessages.EmailErrorMessages.ER002 + ": " + sendGridResponse.getBody());
        }
        catch (Exception e){
    ...
    public void cancelEmail(String batchId) {
        ...
        try {
            ...
            throw new BadRequestException(ErrorMessages.EmailErrorMessages.ER003 + ": " + sendGridResponse.getBody());
        } catch (Exception e) {
