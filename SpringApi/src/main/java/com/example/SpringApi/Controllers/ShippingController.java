 ...
 * All endpoints require proper authorization and include comprehensive error
 * handling.
 * 
...
public class ShippingController {
     ...
     * Groups products by pickup location and returns available couriers for each
     * location.
     * Requires VIEW_PURCHASE_ORDERS_PERMISSION to access.
     * 
     * @param request Contains delivery postcode, COD flag, and list of pickup
     *                locations with weights
     * @return ResponseEntity containing shipping options for each pickup location
     *         or error
     */
     ...
     * Requires VIEW_PURCHASE_ORDERS_PERMISSION to access.
     * 
     * @param request Contains map of product IDs to quantities and delivery
     *                postcode
    ...
    /**
     * Cancel a shipment.
     * Cancels the shipment in ShipRocket and updates the local shipment status to
     * CANCELLED.
     ...
     * Creates a return shipment in ShipRocket and stores the return details
     * locally.
     * Requires MODIFY_SHIPMENTS_PERMISSION to access.
     * 
     * @param request The return request containing shipment ID and products to
     *                return
     * @return ResponseEntity containing the created return shipment details or
     *         error
     */
    @PreAuthorize("@customAuthorization.hasAuthority('" + Authorizations.MODIFY_SHIPMENTS_PERMISSION + "')")
     ...
     *
     * @param paginationBaseRequestModel The pagination parameters including page
     *                                   size, number, filters, and sorting
    ...
    public ResponseEntity<?> getShipmentsInBatches(
            @RequestBody com.example.SpringApi.Models.RequestModels.PaginationBaseRequestModel paginationBaseRequestModel) {
        try {
