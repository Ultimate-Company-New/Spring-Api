 ...
 *
 * These constants define the image type keys for product images (main, top, bottom, etc.)
 * and should be used consistently in models, services, and tests.
 *
...
public final class ProductImageConstants {
    ...
    public static final List<String> REQUIRED_IMAGE_TYPES = Collections.unmodifiableList(Arrays.asList(
            MAIN, TOP, BOTTOM, FRONT, BACK, RIGHT, LEFT, DETAILS
    ));

    /** Optional image types (defect, additional_1, additional_2, additional_3) */
    public static final List<String> OPTIONAL_IMAGE_TYPES = Collections.unmodifiableList(Arrays.asList(
            DEFECT, ADDITIONAL_1, ADDITIONAL_2, ADDITIONAL_3
    ));
}
