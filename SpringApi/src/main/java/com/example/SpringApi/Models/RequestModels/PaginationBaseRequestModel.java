...
public class PaginationBaseRequestModel {
  ...
  public static class FilterCondition {
    ...
    private static final List<String> SYMBOL_OPERATORS =
        List.of(
            OP_SYMBOL_EQUAL,
            OP_SYMBOL_NOT_EQUAL,
            OP_SYMBOL_GREATER_THAN,
            OP_SYMBOL_GREATER_THAN_OR_EQUAL,
            OP_SYMBOL_LESS_THAN,
            OP_SYMBOL_LESS_THAN_OR_EQUAL);
    ...
    public void validateValuePresence() {
      ...
      if (value == null) {
        throw new IllegalArgumentException(
            String.format(
                "Filter value is required for operator '%s' on column '%s'", operator, column));
      }
    }
  }
}
