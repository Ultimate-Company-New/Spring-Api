...
/**
 * Model to represent a pickup location with its available stock for a product.
 * Contains pickup location details and available stock quantity.
 * 
...
public class ProductPickupLocationItem {
     ...
     */
    public ProductPickupLocationItem(PickupLocationResponseModel pickupLocation, Integer availableStock) {
