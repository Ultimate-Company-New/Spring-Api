 ...
 * 
 * Tracks batch/service test run execution metadata including:
 * - Who ran the tests
 * - When they were run
 * - Total counts (passed, failed, skipped)
 * - Run type (single method, service, all services)
 * 
...
public class TestRun {
    ...
    public void complete() {
        ...
        this.status = this.failedCount > 0 ? TestRunStatus.FAILED.getValue() : TestRunStatus.COMPLETED.getValue();
    }
