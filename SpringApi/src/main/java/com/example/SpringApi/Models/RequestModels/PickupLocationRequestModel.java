 ...
 *
 * <p>This model contains all the fields required for creating or updating a pickup location. It
 * includes validation constraints and business logic requirements.
 *
 * <p>Note: addressNickName has a max length of 36 characters due to Shiprocket API limitation.
 *
