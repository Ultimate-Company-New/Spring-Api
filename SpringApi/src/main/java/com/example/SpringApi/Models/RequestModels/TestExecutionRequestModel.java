 ...
 * - Run all tests (runAll = true)
 * - Run all tests for a service (serviceName only)
 * - Run tests for a specific method (serviceName + methodName)
 * - Run specific tests (testNames list)
 */
@Getter
@Setter
