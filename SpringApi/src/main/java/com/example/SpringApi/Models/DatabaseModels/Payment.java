 ...
 * 
 * Stores comprehensive payment information for orders including:
 * - Razorpay transaction details
 * - Payment status and method
 * - Refund information
 * - Fee breakdown
 * 
 * Supports polymorphic association via entityType + entityId to link to 
 * PurchaseOrder, Order, or any other payable entity.
 * 
...
public class Payment {
     ...
     */
    public void markAsCaptured(String razorpayPaymentId, String razorpaySignature, 
                                String paymentMethod, Long amountPaidPaise, String modifiedUser) {
    ...
    public void markAsFailed(String errorCode, String errorDescription, 
                              String errorSource, String errorReason, String modifiedUser) {
    ...
    public void recordRefund(String refundId, Long refundAmountPaise, String modifiedUser) {
        ...
        long totalRefunded = (this.amountRefundedPaise != null ? this.amountRefundedPaise : 0L) + refundAmountPaise;
     ...
     * Sets card details
     */
    public void setCardDetails(String last4, String network, String type, 
                                String issuer, Boolean international, Integer emiTenure) {
