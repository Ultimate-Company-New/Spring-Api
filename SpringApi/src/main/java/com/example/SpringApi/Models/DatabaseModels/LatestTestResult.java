 ...
 * 
 * Stores the latest result for each unique test (per client).
 * This table is upserted on each test run to maintain current status.
 * Used for quick lookups of current test status without querying history.
 * 
