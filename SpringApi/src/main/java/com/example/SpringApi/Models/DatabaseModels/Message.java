 ...
 *
 * <p>This entity represents messages for user communication and notifications. It includes user
 * association and email integration capabilities.
 *
...
public class Message {
   ...
   */
  public Message(
      MessageRequestModel request, Long createdByUserId, String createdUser, Long clientId) {
    ...
    if (existingMessage != null) {
      ...
      if (existingSendAsEmail && existingPublishDate != null) {
        ...
        if (!requestSendAsEmail) {
          throw new BadRequestException(
              ErrorMessages.MessagesErrorMessages.CANNOT_DISABLE_SEND_AS_EMAIL_SCHEDULED);
        }
      }
    }
  ...
  private void setFieldsFromRequest(MessageRequestModel request) {
    ...
    this.sendgridEmailBatchId =
        request.getSendgridEmailBatchId() != null ? request.getSendgridEmailBatchId().trim() : null;
