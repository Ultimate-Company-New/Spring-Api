 ...
 *
 * <p>This entity represents a client/tenant in the multi-tenant system. It contains all
 * client-specific configuration including integration settings for SendGrid, Razorpay, ShipRocket,
 * and Jira.
 *
...
public class Client {
  ...
  private void validateUpdateRequest(ClientRequestModel request) {
    ...
    if (request.getSendgridSenderName() != null
        && request.getSendgridSenderName().trim().isEmpty()) {
  ...
  /**
   * Sets fields from the request model. Handles null values for optional fields.
   *
  ...
  private void setFieldsFromRequest(ClientRequestModel request) {
    ...
    this.sendGridApiKey =
        request.getSendGridApiKey() != null ? request.getSendGridApiKey().trim() : null;
    this.sendGridEmailAddress =
        request.getSendGridEmailAddress() != null ? request.getSendGridEmailAddress().trim() : null;
    this.isDeleted =
        request.getIsDeleted() != null
            ? request.getIsDeleted()
            : Boolean.FALSE; // Default false if null
    ...
    this.sendgridSenderName =
        request.getSendgridSenderName() != null ? request.getSendgridSenderName().trim() : null;
    this.razorpayApiKey =
        request.getRazorpayApiKey() != null ? request.getRazorpayApiKey().trim() : null;
    this.razorpayApiSecret =
        request.getRazorpayApiSecret() != null ? request.getRazorpayApiSecret().trim() : null;
    this.imgbbApiKey = request.getImgbbApiKey() != null ? request.getImgbbApiKey().trim() : null;
    this.shipRocketEmail =
        request.getShipRocketEmail() != null ? request.getShipRocketEmail().trim() : null;
    this.shipRocketPassword =
        request.getShipRocketPassword() != null ? request.getShipRocketPassword().trim() : null;
    ...
    this.jiraProjectUrl =
        request.getJiraProjectUrl() != null ? request.getJiraProjectUrl().trim() : null;
    this.jiraProjectKey =
        request.getJiraProjectKey() != null ? request.getJiraProjectKey().trim() : null;
