...
/**
 * Request model for creating a return order in ShipRocket.
 * POST /orders/create/return
 * 
 * Note: For returns, the pickup location is where the customer is (delivery address of original order)
 * and the shipping location is where the product should be returned to (original pickup location).
 */
@Getter
@Setter
