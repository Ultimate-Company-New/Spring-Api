 ...
 *
 * <p>This entity represents promotional codes and discount offers. It includes client association
 * and discount calculation logic.
 *
  ...
  private void validateRequest(PromoRequestModel request) {
    ...
    if (request.getDiscountValue() == null
      ...
      throw new BadRequestException(
          ErrorMessages.PromoErrorMessages.DISCOUNT_VALUE_GREATER_THAN_ZERO);
    }

    // Validate percentage constraint (if percentage, must be <= 100)
    if (request.getIsPercent() != null
        && request.getIsPercent()
    ...
    if (request.getExpiryDate() != null
      ...
      throw new BadRequestException(
          ErrorMessages.PromoErrorMessages.EXPIRY_DATE_MUST_BE_AFTER_START_DATE);
    }
  }
