 ...
 *
 * <p>This entity represents leads for sales and marketing customer acquisition. It includes contact
 * information, company details, and assignment tracking.
 *
...
public class Lead {
  ...
  public static final java.util.Set<String> VALID_LEAD_STATUSES =
      java.util.Set.of(
  ...
  private void setFieldsFromRequest(LeadRequestModel request) {
    this.annualRevenue =
        request.getAnnualRevenue() != null ? request.getAnnualRevenue().trim() : null;
