 ...
 * 
 * API: GET https://apiv2.shiprocket.in/v1/external/orders/show/{order_id}
 * 
 * This model captures the complete order details returned by ShipRocket
 * after an order is created, including shipment details, AWB data, and more.
 * 
