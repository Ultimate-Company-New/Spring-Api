 ...
 * 
 * This model includes the category information along with its complete
 * breadcrumb path from root to leaf, making it easy for frontend to display
 * searchable category selections.
 * 
...
public class ProductCategoryWithPathResponseModel {
     ...
     */
    public ProductCategoryWithPathResponseModel(Long categoryId, String name, String fullPath, Long parentId, Boolean isEnd) {
