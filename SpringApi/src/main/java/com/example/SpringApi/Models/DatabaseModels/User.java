 ...
 *
 * <p>This entity maps to the User table in the UltimateCompany database and includes all
 * user-related fields, relationships, and business logic. It provides constructors for both
 * creation and update scenarios with proper validation and audit handling.
 *
...
public class User {
  ...
  public User(UserRequestModel request, String modifiedUser, User existingUser) {
    ...
    // Preserve profile picture URL from existing user (may have been updated during profile picture
    // upload)
  ...
  private void setFieldsFromRequest(UserRequestModel request) {
    ...
    this.emailConfirmed =
        request.getEmailConfirmed() != null ? request.getEmailConfirmed() : Boolean.FALSE;
