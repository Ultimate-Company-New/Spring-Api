...
/**
 * Response model for ReturnShipment data.
 * Used to return return shipment information in API responses.
 */
@Getter
@Setter
public class ReturnShipmentResponseModel {
    ...
    public ReturnShipmentResponseModel(ReturnShipment returnShipment) {
        ...
        this.returnType = returnShipment.getReturnType() != null ? returnShipment.getReturnType().getValue() : null;
