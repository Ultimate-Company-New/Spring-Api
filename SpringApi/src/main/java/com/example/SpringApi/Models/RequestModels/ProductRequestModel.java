 ...
 *
 * <p>This model contains all the fields required for creating or updating a product.
 *
...
public class ProductRequestModel {
  ...
  /**
   * Date and time when the product becomes available for sale. Stored in the specified timezone.
   */
