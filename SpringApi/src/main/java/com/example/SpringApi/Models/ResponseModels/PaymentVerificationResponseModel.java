 ...
 * Indicates whether the payment was successfully verified and processed.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class PaymentVerificationResponseModel {
     ...
     */
    public static PaymentVerificationResponseModel success(String paymentId, Long purchaseOrderId, String status) {
