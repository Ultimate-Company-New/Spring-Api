 ...
 * Can contain either online payment (RazorpayVerifyRequestModel) or cash payment (CashPaymentRequestModel).
 */
@Getter
@Setter
public class ProcessPaymentAndShipmentRequestModel {
    /**
     * Whether this is a cash payment (true) or online payment (false)
     * Using @JsonProperty to ensure correct JSON mapping since boolean fields starting with "is" can cause issues
     * Excluded from Lombok getter/setter to use custom methods
     */
