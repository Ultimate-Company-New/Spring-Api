 ...
 * 
 * This entity stores which packages are used in each shipment.
 * 
...
public class ShipmentPackage {
    ...
    // Relationships
    @OneToMany(mappedBy = "shipmentPackage", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
     ...
     */
    public ShipmentPackage(Long shipmentId,
