...
/**
 * Holds a PurchaseOrder with all related data loaded in a single query.
 * Used as the page object for getPurchaseOrdersInBatches - extract and build response model.
 */
@Getter
public class PurchaseOrderWithDetails {
    ...
    public PurchaseOrderWithDetails(PurchaseOrder purchaseOrder, OrderSummary orderSummary,
                                   List<Resources> attachments, List<Payment> payments) {
