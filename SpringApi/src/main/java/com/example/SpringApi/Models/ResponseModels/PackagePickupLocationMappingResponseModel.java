 ...
 * 
 * This model is used for returning package inventory information at pickup locations
 * in API responses. Includes all audit fields for complete information.
 * 
...
public class PackagePickupLocationMappingResponseModel {
     ...
     * Maps to the availableQuantity column.
     */
    ...
    /**
     * Constructor with essential inventory fields (for backward compatibility).
     * Used when only inventory data is needed without full audit info.
     * 
     ...
     */
    public PackagePickupLocationMappingResponseModel(Integer quantity, Integer reorderLevel, 
