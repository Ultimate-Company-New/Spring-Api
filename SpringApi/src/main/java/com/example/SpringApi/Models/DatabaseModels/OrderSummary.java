 ...
 * 
 * This entity stores the financial breakdown and fulfillment details for any order entity (PurchaseOrder or Order).
 * Uses polymorphic association pattern via entityType + entityId to link to PurchaseOrder or Order.
 * 
...
public class OrderSummary {
     ...
     * @param orderSummaryData The order summary data from request model (contains all financial and fulfillment data)
     ...
     */
    public OrderSummary(String entityType, Long entityId, 
                       com.example.SpringApi.Models.RequestModels.PurchaseOrderRequestModel.OrderSummaryData orderSummaryData,
                       Long entityAddressId, Long clientId, String createdUser) {
    ...
    public OrderSummary(String entityType, Long entityId,
                       com.example.SpringApi.Models.RequestModels.PurchaseOrderRequestModel.OrderSummaryData orderSummaryData,
                       Long entityAddressId, String modifiedUser, OrderSummary existingOrderSummary) {
     ...
     */
    private void validateRequest(String entityType, Long entityId,
                                 com.example.SpringApi.Models.RequestModels.PurchaseOrderRequestModel.OrderSummaryData orderSummaryData,
