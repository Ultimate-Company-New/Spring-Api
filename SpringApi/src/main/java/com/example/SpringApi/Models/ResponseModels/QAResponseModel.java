 ...
 * 
 * This model provides complete information about a service including all its
 * public endpoints and the associated unit tests for each method. This enables
 * QA teams to understand test coverage at a service level.
 * 
 * Test naming convention: methodName_Result_Outcome
...
public class QAResponseModel {
     ...
     */
    public QAResponseModel(String serviceName, String controllerName, String basePath, String testClassName) {
    ...
    public static class MethodInfo {
        ...
        /**
         * List of unit tests associated with this service method.
         * Test names follow the pattern: methodName_Result_Outcome
         */
        ...
        public void addUnitTest(TestInfo testInfo) {
            if (testInfo != null && testInfo.getTestMethodName() != null && !testInfo.getTestMethodName().trim().isEmpty()) {
    ...
    public static class TestInfo {
         ...
         * <p>
         * This is used for Maven/Surefire test selection.
         * For @Nested tests, this will include the nested class using '$'
         * (e.g., "AddressServiceTest$GetAddressByIdTests").
         * For non-nested tests, this will typically be the outer test class name
         * (e.g., "AddressServiceTest").
         */
        private String declaringTestClassName;
        
        /**
         * The human-readable display name from @DisplayName annotation
         * (e.g., "Toggle Address - Address not found - ThrowsNotFoundException")
         */
