...
public class ErrorMessages {
    ...
    public static final String INVALID_COLUMN = "Invalid column, the column should be one of the following: ";
    public static final String INVALID_ADDRESS = "Invalid address, please check all the address fields entered. Address line 1, address line 2, city, state, zip code are all required fields";
    public static final String INVALID_PHONE = "Invalid phone number, please check the entered phone number. Phone number should be of 10 numbers";
    ...
    public static class ClientErrorMessages {
        ...
        public static final String DUPLICATE_CLIENT_NAME_FORMAT = "A client with the name '%s' already exists.";
        public static final String INVALID_NAME = "Client name is required and cannot be empty.";
        public static final String INVALID_DESCRIPTION = "Client description is required and cannot be empty.";
        public static final String INVALID_SUPPORT_EMAIL = "Client support email is required and cannot be empty.";
        public static final String INVALID_WEBSITE = "Client website is required and cannot be empty.";
        public static final String INVALID_SENDGRID_SENDER_NAME = "SendGrid sender name is required and cannot be empty.";
        public static final String INVALID_LOGO_UPLOAD = "Failed to upload logo to Firebase.";
        public static final String CLIENTS_LIST_NULL = "Cannot invoke \"java.util.List.iterator()\" because \"clients\" is null";
    }
    ...
    public static class LoginErrorMessages {
        ...
        public static final String GOOGLE_USER_INCONSISTENCY = "User present in google users but not present in system users";
        ...
        public static final String NULL_REQUEST = "Cannot invoke \"com.example.SpringApi.Models.RequestModels.LoginRequestModel.getLoginName()\" because \"loginRequestModel\" is null";
    ...
    public static class MessagesErrorMessages {
        ...
        public static final String NULL_PAGINATION_REQUEST = "Cannot invoke \"com.example.SpringApi.Models.RequestModels.PaginationBaseRequestModel.getId()\" because \"paginationBaseRequestModel\" is null";
        ...
        public static final String PUBLISH_DATE_REQUIRES_SEND_AS_EMAIL = "If publish date is set, sendAsEmail must be true.";
        public static final String CANNOT_DISABLE_SEND_AS_EMAIL_ONCE = "Cannot disable sendAsEmail once it has been enabled.";
        public static final String CANNOT_ADD_PUBLISH_DATE_AFTER_SENT = "Cannot add publish date to a message that was already sent as email without scheduling.";
        public static final String CANNOT_MODIFY_SCHEDULED_PUBLISH_DATE = "Cannot modify publish date for a scheduled email.";
        public static final String CANNOT_DISABLE_SEND_AS_EMAIL_SCHEDULED = "Cannot disable sendAsEmail for a scheduled email.";
    ...
    public static class PackageErrorMessages {
        ...
        public static final String INVALID_PACKAGE_NAME = "Package name is required and cannot be empty.";
        public static final String INVALID_LENGTH = "Package length is required and must be greater than 0.";
        public static final String INVALID_BREADTH = "Package breadth is required and must be greater than 0.";
        public static final String INVALID_HEIGHT = "Package height is required and must be greater than 0.";
        public static final String INVALID_MAX_WEIGHT = "Package max weight is required and must be greater than or equal to 0.";
        public static final String INVALID_STANDARD_CAPACITY = "Package standard capacity is required and must be greater than 0.";
        public static final String INVALID_PRICE_PER_UNIT = "Package price per unit is required and must be greater than or equal to 0.";
        public static final String INVALID_PACKAGE_TYPE = "Package type is required and cannot be empty.";
        ...
        public static final String INVALID_OPERATOR_FOR_COLUMN_FORMAT = "Operator '%s' is not valid for column '%s'";
    ...
    public static class PickupLocationErrorMessages {
        ...
        public static final String INVALID_ADDRESS_NICK_NAME = "Address nickname is required and cannot be empty.";
        public static final String ADDRESS_NICK_NAME_TOO_LONG = "Address nickname cannot exceed 255 characters.";
        public static final String INVALID_SHIP_ROCKET_ID = "ShipRocket pickup location ID must be greater than 0.";
        /** Format: "Invalid column name: %s" */
        public static final String INVALID_COLUMN_NAME_FORMAT = "Invalid column name: %s";
        /** Format: "Invalid operator: %s" */
        public static final String INVALID_OPERATOR_FORMAT = "Invalid operator: %s";
         ...
         */
        public static final String SHIP_ROCKET_PICKUP_LOCATION_ID_INVALID_FORMAT = "Failed to retrieve ShipRocket pickup location ID after creation. Response pickup_id: %d is invalid. Please verify the pickup location was created successfully in ShipRocket.";
        ...
        public static final String LOCATION_NAME_TOO_LONG = "Location name must be 36 characters or less (Shiprocket limit).";
    }
    ...
    public static class PromoErrorMessages {
        ...
        public static final String OVERLAPPING_PROMO_CODE = "A promo with this code already exists during the specified time period.";
        ...
        public static final String INVALID_DISCOUNT_VALUE = "Discount value is required and must be greater than or equal to 0.";
        ...
        public static final String START_DATE_MUST_BE_TODAY_OR_FUTURE = "Start date must be today or in the future.";
        public static final String INVALID_EXPIRY_DATE = "Expiry date must be today or in the future.";
        public static final String EXPIRY_DATE_MUST_BE_AFTER_START_DATE = "Expiry date must be after or equal to start date.";
        public static final String PROMO_CODE_ALPHA_NUMERIC = "Promo code must contain only alphanumeric characters.";
        public static final String PROMO_CODE_LENGTH = "Promo code must be between 3 and 50 characters.";
        public static final String DISCOUNT_VALUE_GREATER_THAN_ZERO = "Discount value must be greater than zero.";
    ...
    public static class ProductErrorMessages {
        ...
        public static final String INVALID_DESCRIPTION = "Product description is required and cannot be empty.";
        public static final String INVALID_BRAND = "Product brand is required and cannot be empty.";
        public static final String INVALID_COLOR_LABEL = "Product color label is required and cannot be empty.";
        public static final String INVALID_CONDITION = "Product condition is required and cannot be empty.";
        /** Format: "Product condition must be one of: %s" */
        public static final String INVALID_CONDITION_VALUE_FORMAT = "Product condition must be one of: %s";
        public static final String INVALID_COUNTRY_OF_MANUFACTURE = "Product country of manufacture is required and cannot be empty.";
        public static final String INVALID_PRICE = "Product price is required and must be greater than or equal to 0.";
        ...
        public static final String INVALID_PICKUP_LOCATION_ID = "Product pickup location ID is required and cannot be 0.";
        ...
        public static final String INVALID_WEIGHT = "Product weight must be greater than or equal to 0.";
        public static final String INVALID_PICKUP_LOCATION_QUANTITY = "Pickup location quantity must be greater than or equal to 0.";
        /** Format: "Available stock for pickup location %d must be positive." */
        public static final String INVALID_PICKUP_LOCATION_QUANTITY_FORMAT = "Available stock for pickup location %d must be positive.";
        ...
        public static final String HTTP_ERROR_WHEN_FETCHING_IMAGE_FORMAT = "HTTP %d when fetching image";
        /** Format: "Invalid column name: %s" */
        public static final String INVALID_COLUMN_NAME_FORMAT = "Invalid column name: %s";
        /** Format: "Invalid operator: %s" */
        public static final String INVALID_OPERATOR_FORMAT = "Invalid operator: %s";
        /** Format: "Operator '%s' is not valid for %s column '%s'" */
        public static final String INVALID_OPERATOR_FOR_COLUMN_FORMAT = "Operator '%s' is not valid for %s column '%s'";
        ...
        public static final String NO_PICKUP_LOCATIONS_FOUND = "No pickup locations found for this product.";
        public static final String AT_LEAST_ONE_PICKUP_LOCATION_REQUIRED = "At least one pickup location with quantity must be provided.";
    }
    ...
    public static class LeadsErrorMessages {
        ...
        public static final String INVALID_COLUMN_NAME_WITH_VALID_COLUMNS_FORMAT = "Invalid column name: %s. Valid columns are: %s";
        /** Format: "Operator '%s' is not valid for column '%s'" */
        public static final String INVALID_OPERATOR_FOR_COLUMN_FORMAT = "Operator '%s' is not valid for column '%s'";
        /** Format: "Bulk item error: %s" */
        public static final String BULK_ITEM_ERROR_FORMAT = "Bulk item error: %s";
    ...
    public static class PurchaseOrderErrorMessages {
        ...
        public static final String INVALID_VENDOR_NUMBER = "Vendor number is required and cannot be empty.";
        public static final String INVALID_TERMS_CONDITIONS = "Terms and conditions HTML is required and cannot be empty.";
        public static final String INVALID_ORDER_STATUS = "Order status is required and cannot be empty.";
        public static final String INVALID_ORDER_STATUS_VALUE = "Invalid purchase order status.";
        public static final String INVALID_PAYMENT_STATUS = "Payment status is required and cannot be empty.";
        public static final String INVALID_TOTAL_AMOUNT = "Total amount is required and must be greater than or equal to 0.";
        public static final String INVALID_AMOUNT_PAID = "Amount paid is required and must be greater than or equal to 0.";
        public static final String AMOUNT_PAID_EXCEEDS_TOTAL = "Amount paid cannot exceed total amount.";
        ...
        public static final String INVALID_PRIORITY = "Priority is required and must be one of: LOW, MEDIUM, HIGH, URGENT.";
        ...
        public static final String AT_LEAST_ONE_SHIPMENT_REQUIRED = "At least one shipment is required for purchase order.";
        public static final String IMGBB_API_KEY_NOT_CONFIGURED = "ImgBB API key is not configured for this client";
        public static final String INVALID_ATTACHMENT_DATA = "Each attachment must have a valid fileName (key) and base64 data (value)";
        ...
        public static final String BOOLEAN_COLUMNS_ONLY_SUPPORT_EQUALS = "Boolean columns only support 'equals' and 'notEquals' operators";
        public static final String COLUMNS_ONLY_SUPPORT_NUMERIC_OPERATORS = "%s columns only support numeric comparison operators";
        public static final String INVALID_PAGINATION = "Invalid pagination: end must be greater than start";
        ...
        public static final String MAX_ATTACHMENTS_EXCEEDED = "Maximum 30 attachments allowed per purchase order.";
        public static final String AT_LEAST_ONE_PRODUCT_REQUIRED = "At least one product must be specified in products list";
        /** Format: "pricePerUnit is required for productId %s" */
        public static final String PRICE_PER_UNIT_REQUIRED_FOR_PRODUCT_FORMAT = "pricePerUnit is required for productId %s";
        /**
         * Format: "pricePerUnit must be greater than or equal to 0 for productId %s"
         */
        public static final String PRICE_PER_UNIT_MUST_BE_NON_NEGATIVE_FOR_PRODUCT_FORMAT = "pricePerUnit must be greater than or equal to 0 for productId %s";
        /** Format: "Duplicate productId in products list: %s" */
        public static final String DUPLICATE_PRODUCT_ID_FORMAT = "Duplicate productId in products list: %s";
    }
    ...
    public static class TestExecutorErrorMessages {
        ...
        public static final String FAILED_TO_PARSE_SUREFIRE_REPORT_FORMAT = "Failed to parse Surefire report: %s";
        /** Format: "I/O error during test execution: %s" */
        public static final String IO_ERROR_DURING_EXECUTION_FORMAT = "I/O error during test execution: %s";
    ...
    public static class QAErrorMessages {
        ...
        public static final String SERVICE_NOT_FOUND_FORMAT = "Service not found: %s. Available services: %s";
        /** Format: "Could not load service class: %s" */
        public static final String COULD_NOT_LOAD_SERVICE_CLASS_FORMAT = "Could not load service class: %s";
        ...
        public static final String AT_LEAST_ONE_TEST_RESULT_REQUIRED = "At least one test result is required";

        // Test execution validation
        public static final String TEST_EXECUTION_REQUEST_CANNOT_BE_NULL = "Test execution request cannot be null";
        public static final String SERVICE_NAME_NULL = "Service name cannot be null or empty";
        public static final String TEST_CLASS_NAME_REQUIRED = "testClassName is required when running specific tests";
        public static final String MUST_SPECIFY_SERVICE_NAME_OR_TEST_CLASS_NAME = "Must specify serviceName or testClassName when running tests by method name";
        /** Format: "No tests found for method: %s in class %s" */
        public static final String NO_TESTS_FOUND_FOR_METHOD_FORMAT = "No tests found for method: %s in class %s";
        public static final String MUST_SPECIFY_RUN_ALL_OR_TEST_NAMES_OR_METHOD = "Must specify runAll, testNames, or methodName+testClassName";
    ...
    public static class ProductPickupLocationMappingErrorMessages {
        ...
        public static final String AT_LEAST_ONE_PICKUP_LOCATION_REQUIRED = "At least one pickup location with quantity must be provided.";
        public static final String AVAILABLE_STOCK_MUST_BE_POSITIVE = "Available stock for pickup location %d must be positive.";
    }
    ...
    public static class OrderSummaryErrorMessages {
        ...
        public static final String ENTITY_TYPE_REQUIRED = "Entity type is required and cannot be empty.";
        public static final String INVALID_ENTITY_TYPE = "Invalid entity type. Must be 'PURCHASE_ORDER' or 'ORDER'.";
        public static final String ENTITY_ID_REQUIRED = "Entity ID is required and must be greater than 0.";
        public static final String PRODUCTS_SUBTOTAL_REQUIRED = "productsSubtotal is required.";
        public static final String PRODUCTS_SUBTOTAL_INVALID = "productsSubtotal must be greater than or equal to 0.";
        public static final String TOTAL_DISCOUNT_INVALID = "totalDiscount must be greater than or equal to 0.";
        public static final String PACKAGING_FEE_INVALID = "packagingFee must be greater than or equal to 0.";
        public static final String TOTAL_SHIPPING_INVALID = "totalShipping must be greater than or equal to 0.";
        public static final String INVALID_GST_PERCENTAGE = "GST percentage must be between 0 and 100.";
        public static final String ENTITY_ADDRESS_ID_REQUIRED = "Entity address ID is required and must be greater than 0.";
        public static final String PRIORITY_REQUIRED = "Priority is required and cannot be empty.";
        public static final String INVALID_PRIORITY = "Invalid priority. Must be 'LOW', 'MEDIUM', 'HIGH', or 'URGENT'.";
        public static final String PAID_AMOUNT_INVALID = "Paid amount must be greater than or equal to 0.";
        public static final String PAID_AMOUNT_EXCEEDS_GRAND_TOTAL = "Paid amount cannot exceed grand total.";
    }
    ...
    public static class ShipmentErrorMessages {
        ...
        public static final String ORDER_SUMMARY_ID_REQUIRED = "Order summary ID is required and must be greater than 0.";
        public static final String TOTAL_WEIGHT_REQUIRED = "Total weight is required.";
        public static final String TOTAL_WEIGHT_INVALID = "Total weight must be greater than or equal to 0.";
        public static final String TOTAL_QUANTITY_REQUIRED = "Total quantity is required and must be greater than 0.";
        public static final String PACKAGING_COST_REQUIRED = "packagingCost is required.";
        public static final String PACKAGING_COST_INVALID = "packagingCost must be greater than or equal to 0.";
        public static final String SHIPPING_COST_REQUIRED = "shippingCost is required.";
        public static final String SHIPPING_COST_INVALID = "shippingCost must be greater than or equal to 0.";
        public static final String COURIER_SELECTION_REQUIRED = "Each shipment must have at least one courier selected.";
        public static final String ALREADY_CANCELLED = "Shipment is already cancelled.";
        public static final String NO_SHIP_ROCKET_ORDER_ID = "Shipment does not have a ShipRocket order ID. Cannot cancel.";
        ...
        public static final String INVALID_ID_FORMAT_ERROR_FORMAT = "Invalid shipment Id. Format error: %s";
    ...
    public static class ShipmentProductErrorMessages {
        ...
        public static final String SHIPMENT_ID_REQUIRED = "Shipment ID is required and must be greater than 0.";
        public static final String ALLOCATED_QUANTITY_REQUIRED = "Allocated quantity is required and must be greater than 0.";
        public static final String ALLOCATED_PRICE_REQUIRED = "Allocated price is required.";
        public static final String ALLOCATED_PRICE_INVALID = "Allocated price must be greater than or equal to 0.";
    }
    ...
    public static class ShipmentPackageErrorMessages {
        ...
        public static final String SHIPMENT_ID_REQUIRED = "Shipment ID is required and must be greater than 0.";
        public static final String QUANTITY_USED_REQUIRED = "Quantity used is required and must be greater than 0.";
        public static final String TOTAL_COST_REQUIRED = "Total cost is required.";
        public static final String TOTAL_COST_INVALID = "Total cost must be greater than or equal to 0.";
        public static final String AT_LEAST_ONE_PACKAGE_REQUIRED = "Each shipment must have at least one package.";
    }
    ...
    public static class ShipmentPackageProductErrorMessages {
        ...
        public static final String SHIPMENT_PACKAGE_ID_REQUIRED = "Shipment package ID is required and must be greater than 0.";
        public static final String QUANTITY_REQUIRED = "Quantity is required and must be greater than 0.";
        public static final String AT_LEAST_ONE_PRODUCT_REQUIRED = "Each package must have at least one product.";
    }
    ...
    public static class ReturnShipmentErrorMessages {
        ...
        public static final String NO_SHIP_ROCKET_ORDER_ID = "Cannot cancel return shipment: ShipRocket return order ID not found.";
        public static final String SHIPMENT_ID_REQUIRED = "Shipment ID is required.";
        public static final String AT_LEAST_ONE_PRODUCT_REQUIRED = "At least one product must be selected for return.";
        public static final String PRODUCT_ID_REQUIRED = "Product ID is required for each return item.";
        public static final String VALID_QUANTITY_REQUIRED = "Valid quantity is required for each return item.";
        public static final String RETURN_REASON_REQUIRED = "Return reason is required for each product.";
        public static final String ONLY_DELIVERED_CAN_RETURN = "Can only create return for delivered shipments. Current status: %s";
        public static final String PRODUCT_NOT_IN_SHIPMENT = "Product ID %d is not part of this shipment.";
        public static final String RETURN_QUANTITY_EXCEEDS = "Return quantity (%d) exceeds shipment quantity (%d) for product %d.";
        public static final String PRODUCT_PAST_RETURN_WINDOW = "Product '%s' is past its return window of %d days.";
        public static final String PRODUCT_NOT_RETURNABLE = "Product '%s' is not returnable (return window is 0).";
        public static final String FAILED_TO_CREATE_RETURN = "Failed to create return order in ShipRocket: %s";
        public static final String FAILED_TO_CANCEL_RETURN = "Failed to cancel return shipment in ShipRocket: %s";
    }
    ...
    public static class ShippingErrorMessages {
        ...
        public static final String NULL_SHIPPING_CALCULATION_REQUEST = "Shipping calculation request cannot be null.";

        // ShipRocket configuration errors
        public static final String SHIP_ROCKET_CREDENTIALS_NOT_CONFIGURED = "Shiprocket credentials not configured for this client.";
        public static final String DELIVERY_ADDRESS_NOT_FOUND = "Delivery address not found in order summary.";

        // Wallet errors
        public static final String WALLET_BALANCE_NOT_AVAILABLE = "Wallet balance not available.";

        // Pickup location errors
        public static final String PICKUP_LOCATION_NAME_NOT_CONFIGURED = "Pickup location name (addressNickName) is not configured for pickup location ID: %d";

        // Billing address validation errors
        public static final String BILLING_POSTAL_CODE_MUST_BE_NUMERIC = "Billing postal code must be numeric. Provided value: %s";
        public static final String BILLING_PHONE_MUST_BE10_DIGITS = "Billing phone number must be exactly 10 digits. Provided value: %s";

        // Shipping address validation errors
        public static final String SHIPPING_POSTAL_CODE_MUST_BE_NUMERIC = "Shipping postal code must be numeric. Provided value: %s";
        public static final String SHIPPING_PHONE_MUST_BE10_DIGITS = "Shipping phone number must be exactly 10 digits. Provided value: %s";

        // ShipRocket API errors
        public static final String SHIP_ROCKET_API_NULL_RESPONSE = "ShipRocket API returned null response for shipment ID: %d";
        public static final String SHIP_ROCKET_ORDER_CREATION_FAILED = "Failed to create ShipRocket order for shipment ID: %d. Error: %s";

        // ShipRocket operation errors
        public static final String AWB_ASSIGNMENT_FAILED = "Failed to assign AWB code for ShipRocket shipment ID: %d. Error: %s";
        public static final String PICKUP_GENERATION_FAILED = "Failed to generate pickup for ShipRocket shipment ID: %d. Error: %s";
        public static final String MANIFEST_GENERATION_FAILED = "Failed to generate manifest for ShipRocket shipment ID: %d. Error: %s";
        public static final String LABEL_GENERATION_FAILED = "Failed to generate shipping label for ShipRocket shipment ID: %d. Error: %s";
        public static final String INVOICE_GENERATION_FAILED = "Failed to generate invoice for ShipRocket shipment ID: %d. Error: %s";
        public static final String TRACKING_FETCH_FAILED = "Failed to fetch tracking information for AWB code: %s. Error: %s";
        /** Format: "invalid status '%s'. Valid statuses are: %s" */
        public static final String INVALID_SHIP_ROCKET_STATUS_FORMAT = "invalid status '%s'. Valid statuses are: %s";
        public static final String SHIP_ROCKET_ORDER_ID_MISSING = "order_id is missing from response";
        public static final String SHIP_ROCKET_SHIPMENT_ID_MISSING = "shipment_id is missing from response";
         ...
         * %s"
         */
        public static final String FAILED_TO_SERIALIZE_SHIP_ROCKET_RESPONSE_FORMAT = "Failed to serialize ShipRocket response to JSON for shipment ID %s: %s";
    }
    ...
    public static class OrderOptimizationErrorMessages {
        ...
        public static final String NO_VALID_ALLOCATION_STRATEGIES_FOUND = "No valid allocation strategies found";
        public static final String NO_SHIPPING_OPTIONS_FOR_ANY_STRATEGY = "No shipping options available for any fulfillment strategy. This may be due to weight limits or route restrictions.";
         ...
         * 0"
         */
        public static final String INSUFFICIENT_STOCK_ZERO_FORMAT = "Insufficient stock for product '%s'. Requested: %s, Available stock: 0";
        /**
         * Format: "Product '%s' cannot be packaged. Stock available: %s, but no
         * packages are configured at pickup locations. Requested: %s"
         */
        public static final String NO_PACKAGES_CONFIGURED_FORMAT = "Product '%s' cannot be packaged. Stock available: %s, but no packages are configured at pickup locations. Requested: %s";
        /**
         * Format: "Product '%s' cannot be packaged. Stock available: %s, but no
         * packages are available at pickup locations (all packages have 0 quantity).
         * Requested: %s"
         */
        public static final String NO_PACKAGES_AVAILABLE_FORMAT = "Product '%s' cannot be packaged. Stock available: %s, but no packages are available at pickup locations (all packages have 0 quantity). Requested: %s";
        /**
         ...
         */
        public static final String PRODUCT_EXCEEDS_PACKAGE_LIMITS_FORMAT = "Product '%s' cannot be packaged. Stock available: %s, but product dimensions/weight exceed all available package limits. Requested: %s";
        /**
         * Format: "Product '%s' cannot be packaged with available packages. Stock
         * available: %s, but %s. Requested: %s"
         */
        public static final String CANNOT_PACKAGE_WITH_DETAIL_FORMAT = "Product '%s' cannot be packaged with available packages. Stock available: %s, but %s. Requested: %s";
        public static final String NOT_ENOUGH_PACKAGES_FOR_QUANTITY = "not enough packages available to pack the requested quantity";
        /**
         ...
         */
        public static final String INSUFFICIENT_STOCK_PACKAGING_FORMAT = "Insufficient stock/packaging for product '%s'. Requested: %s, Available stock: %s, Packable (considering packaging constraints): %s";
        /** Format: "Custom allocation validation failed:\n• %s" */
        public static final String CUSTOM_ALLOCATION_VALIDATION_FAILED_FORMAT = "Custom allocation validation failed:\n• %s";
    ...
    public static class ShipmentProcessingErrorMessages {
        ...
        public static final String PRODUCT_NOT_AVAILABLE_AT_PICKUP_LOCATION_FORMAT = "Product ID %s is not available at pickup location ID %s";
        /**
         * Format: "Insufficient stock for product ID %s at pickup location ID %s.
         * Available: %s, Requested: %s"
         */
        public static final String INSUFFICIENT_PRODUCT_STOCK_FORMAT = "Insufficient stock for product ID %s at pickup location ID %s. Available: %s, Requested: %s";
        /** Format: "Package ID %s is not available at pickup location ID %s" */
        public static final String PACKAGE_NOT_AVAILABLE_AT_PICKUP_LOCATION_FORMAT = "Package ID %s is not available at pickup location ID %s";
        /**
         * Format: "Insufficient packages for package ID %s at pickup location ID %s.
         * Available: %s, Requested: %s"
         */
        public static final String INSUFFICIENT_PACKAGE_STOCK_FORMAT = "Insufficient packages for package ID %s at pickup location ID %s. Available: %s, Requested: %s";
    ...
    public static class PaymentErrorMessages {
        ...
        public static final String RAZORPAY_API_KEY_NOT_CONFIGURED = "Razorpay API Key not configured for this client. Please configure in Client Settings.";
        public static final String RAZORPAY_API_SECRET_NOT_CONFIGURED = "Razorpay API Secret not configured for this client. Please configure in Client Settings.";

        // Status errors
        public static final String ONLY_PENDING_APPROVAL_CAN_BE_PAID = "Only orders with PENDING_APPROVAL status can be paid.";
        public static final String FOLLOW_UP_PAYMENT_STATUS_REQUIRED = "Follow-up payments can only be made for APPROVED or APPROVED_WITH_PARTIAL_PAYMENT orders.";
        ...
        public static final String PAYMENT_ORDER_NOT_FOUND = "Payment order not found. Please try again.";
        
        // Additional format messages referenced by PaymentService
        public static final String FAILED_TO_CREATE_RAZORPAY_ORDER_FORMAT = "Failed to create Razorpay order: %s";
        public static final String PAYMENT_AMOUNT_EXCEEDS_PENDING_AMOUNT_FORMAT = "Payment amount %s exceeds pending amount %s";
        public static final String REFUND_AMOUNT_EXCEEDS_REFUNDABLE_AMOUNT_FORMAT = "Refund amount exceeds refundable amount: %s";
        public static final String FAILED_TO_PROCESS_REFUND_FORMAT = "Failed to process refund: %s";
        public static final String PAYMENT_AMOUNT_EXCEEDS_GRAND_TOTAL_FORMAT = "Total paid %s exceeds grand total %s";
    }
    ...
    public static class ConfigurationErrorMessages {
        ...
        public static final String INVALID_IMAGE_LOCATION_CONFIG_FORMAT = "Invalid imageLocation configuration: %s";

        // SendGrid
        public static final String SEND_GRID_EMAIL_NOT_CONFIGURED = "Email sender address is not configured in properties.";
        public static final String SEND_GRID_NAME_NOT_CONFIGURED = "Email sender name is not configured in properties.";
        public static final String SEND_GRID_API_KEY_NOT_CONFIGURED = "SendGrid API key is not configured in properties.";
        public static final String BREVO_API_KEY_NOT_CONFIGURED = "Brevo API key is not configured in properties.";
    ...
    public static class CommonErrorMessages {
        ...
        public static final String END_INDEX_MUST_BE_GREATER_THAN_ZERO = "End index must be greater than 0.";
        public static final String START_INDEX_MUST_BE_LESS_THAN_END = "Start index must be less than end index.";

        // Logic operator errors
        public static final String INVALID_LOGIC_OPERATOR = "Invalid logic operator. Must be 'AND' or 'OR'.";
        ...
        // Access errors
        public static final String ACCESS_DENIED_TO_PURCHASE_ORDER = "Access denied to this purchase order.";

        // Confirmation errors
        public static final String FAILED_TO_SEND_CONFIRMATION_EMAIL = "Failed to send confirmation email.";

        // Permission errors
        public static final String AT_LEAST_ONE_PERMISSION_REQUIRED = "At least one permission mapping is required for the user.";

        public static final String DATABASE_ERROR = "Database error";
        public static final String DATABASE_CONNECTION_ERROR = "Database connection error";
        public static final String INVALID_BULK_REQUEST = "Invalid bulk request, the list cannot be null or empty.";
    ...
    public static class OrderSummaryNotFoundMessage {
        ...
        public static final String PURCHASE_ORDER_NOT_FOUND = "Order summary not found for purchase order.";
    }
