...
public class ShipmentFilterQueryBuilder extends BaseFilterQueryBuilder {
    ...
    protected String mapColumnToField(String column) {
        switch (column) {
            case "shipmentId": return "s.shipmentId";
            case "orderSummaryId": return "s.orderSummaryId";
            case "pickupLocationId": return "s.pickupLocationId";
            case "totalWeightKgs": return "s.totalWeightKgs";
            case "totalQuantity": return "s.totalQuantity";
            case "expectedDeliveryDate": return "s.expectedDeliveryDate";
            case "packagingCost": return "s.packagingCost";
            case "shippingCost": return "s.shippingCost";
            case "totalCost": return "s.totalCost";
            case "selectedCourierCompanyId": return "s.selectedCourierCompanyId";
            case "selectedCourierName": return "s.selectedCourierName";
            case "selectedCourierRate": return "s.selectedCourierRate";
            case "selectedCourierMinWeight": return "s.selectedCourierMinWeight";
            case "shipRocketOrderId": return "s.shipRocketOrderId";
            case "shipRocketShipmentId": return "s.shipRocketShipmentId";
    ...
    protected List<String> getNumberColumns() {
        return Arrays.asList(
            "shipmentId", "orderSummaryId", "pickupLocationId", "totalQuantity",
    ...
    protected List<String> getDecimalColumns() {
        return Arrays.asList(
            "totalWeightKgs", "packagingCost", "shippingCost", "totalCost",
    ...
    /**
     * Finds paginated shipments with multiple filter conditions combined with AND/OR logic.
