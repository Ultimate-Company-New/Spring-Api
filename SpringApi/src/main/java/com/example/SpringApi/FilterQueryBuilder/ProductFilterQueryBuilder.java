...
public class ProductFilterQueryBuilder extends BaseFilterQueryBuilder {
    ...
    protected String mapColumnToField(String column) {
        switch (column) {
            ...
            case "colorLabel": return "p.colorLabel";
            case "condition": return "p.condition";
            case "countryOfManufacture": return "p.countryOfManufacture";
            case "model": return "p.model";
            case "upc": return "p.upc";
            case "modificationHtml": return "p.modificationHtml";
            case "price": return "p.price";
            case "discount": return "p.discount";
            case "isDiscountPercent": return "p.isDiscountPercent";
            case "returnsAllowed": return "p.returnsAllowed";
            case "length": return "p.length";
            case "breadth": return "p.breadth";
            case "height": return "p.height";
            case "weightKgs": return "p.weightKgs";
            case "categoryId": return "p.categoryId";
            case "itemModified": return "p.itemModified";
            case "isDeleted": return "p.isDeleted";
            case "notes": return "p.notes";
            case "createdUser": return "p.createdUser";
