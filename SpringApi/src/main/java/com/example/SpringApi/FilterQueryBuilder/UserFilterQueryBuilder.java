 ...
 * 
 * This can be used as a template for other entities:
 * - LeadFilterQueryBuilder
 * - ProductFilterQueryBuilder
 * - GroupFilterQueryBuilder
 * etc.
 */
@Component
public class UserFilterQueryBuilder extends BaseFilterQueryBuilder {
    ...
    protected String mapColumnToField(String column) {
        switch (column) {
            ...
            case "loginName": return "u.loginName";
            case "role": return "u.role";
            case "dob": return "u.dob";
            case "phone": return "u.phone";
            case "datePasswordChanges": return "u.datePasswordChanges";
            case "loginAttempts": return "u.loginAttempts";
            case "isDeleted": return "u.isDeleted";
            case "locked": return "u.locked";
            case "emailConfirmed": return "u.emailConfirmed";
            case "token": return "u.token";
            case "isGuest": return "u.isGuest";
            case "apiKey": return "u.apiKey";
            case "email": return "u.email";
            case "addressId": return "u.addressId";
            case "profilePicture": return "u.profilePicture";
            case "lastLoginAt": return "u.lastLoginAt";
            case "createdAt": return "u.createdAt";
            case "createdUser": return "u.createdUser";
            case "updatedAt": return "u.updatedAt";
            case "modifiedUser": return "u.modifiedUser";
    ...
    /**
     * Finds paginated users with multiple filter conditions combined with AND/OR logic.
    ...
    public Page<User> findPaginatedEntitiesWithMultipleFilters(
        ...
        String countQuery = "SELECT COUNT(DISTINCT u) FROM User u " +
                "JOIN UserClientMapping ucm ON u.userId = ucm.userId " +
                "LEFT JOIN Address a ON u.addressId = a.addressId " +
                "WHERE ucm.clientId = :clientId ";
