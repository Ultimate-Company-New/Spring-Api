...
public class UserGroupFilterQueryBuilder extends BaseFilterQueryBuilder {
    ...
    protected String mapColumnToField(String column) {
        switch (column) {
            ...
            case "isDeleted": return "ug.isDeleted";
            case "notes": return "ug.notes";
            case "createdUser": return "ug.createdUser";
    ...
    /**
     * Finds paginated user groups with multiple filter conditions combined with AND/OR logic.
