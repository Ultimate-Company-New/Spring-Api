 ...
 * 
 * Supported formats:
 * - ISO 8601 with timezone (e.g., "2026-03-01T17:00:00.000Z", "2026-03-01T17:00:00Z")
 * - ISO 8601 with offset (e.g., "2026-03-01T17:00:00+05:30")
 * - ISO local datetime (e.g., "2026-03-01T17:00:00", "2026-03-01T17:00:00.000")
 * - Simple datetime (e.g., "yyyy-MM-dd'T'HH:mm:ss")
 * - Date only (e.g., "yyyy-MM-dd") - converts to start of day
 * 
 * For timezone-aware formats, the datetime is converted to UTC then to LocalDateTime.
 * 
...
public class FlexibleLocalDateTimeDeserializer extends JsonDeserializer<LocalDateTime> {
    ...
    public LocalDateTime deserialize(JsonParser parser, DeserializationContext context) throws IOException {
        ...
        try {
            ...
            throw new IOException("Cannot parse date/datetime: '" + dateString + 
                "'. Expected formats: 'yyyy-MM-dd', 'yyyy-MM-dd'T'HH:mm:ss', or ISO 8601 with timezone (e.g., '2026-03-01T17:00:00.000Z')", e);
        }
    }
}
