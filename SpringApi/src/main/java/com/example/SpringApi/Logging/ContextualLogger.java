...
public class ContextualLogger {
    ...
    /**
     * Set request body in MDC for logging context.
     * Call this method before processing the request.
     */
    ...
    /**
     * Set current user in MDC for logging context.
     * Call this method when user authentication is established.
     */
    ...
    /**
     * Set request URI in MDC for logging context.
     * Call this method when request is received.
     */
