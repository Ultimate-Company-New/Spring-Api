...
import springapi.models.requestmodels.ProductCategoryRequestModel;

/**
 * JPA Entity for the ProductCategory table.
 *
 * <p>This entity represents hierarchical product category structure.
 *
...
public class ProductCategory {
   ...
   */
  public ProductCategory(
      ProductCategoryRequestModel request, String modifiedUser, ProductCategory existingCategory) {
    validateRequest(request);
