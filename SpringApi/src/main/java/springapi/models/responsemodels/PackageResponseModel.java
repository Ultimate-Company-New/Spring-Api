 ...
 *
 * <p>This model is used for returning package information in API responses.
 *
...
public class PackageResponseModel {
   ...
   */
  private Map<Long, PackagePickupLocationMappingResponseModel> pickupLocationQuantities =
      new HashMap<>();
