...
public class ApiRoutes {
  ...
  public static class EventSubRoute {
    ...
    public static final String GET_ALL_EVENTS_FOR_USERID_BASED_ON_MONTH =
        "getAllEventsForUserIdBasedOnMonth";
  ...
  public static class ClientSubRoute {
    ...
    public static final String TOGGLE_CLIENT = "toggleClient";
  ...
  public static class CarriersSubRoute {
    ...
    // Public endpoints
    public static final String GET_CARRIER_ID_BY_WEB_TEMPLATE_WILDCARD =
        "getCarrierIdByWebTemplateWildCard";
  ...
  public static class MessagesSubRoute {
    ...
    public static final String SET_MESSAGE_READ_BY_USER_ID_AND_MESSAGE_ID =
  ...
  public static class ProductCategorySubRoute {
    ...
    public static final String GET_CHILD_CATEGORIES_GIVEN_PARENT_ID =
        "getChildCategoriesGivenParentId";
  ...
  public static class ProductsSubRoute {
    ...
    public static final String GET_PRODUCT_STOCK_AT_LOCATIONS_BY_PRODUCT_ID =
  ...
  public static class GridSubRoute {
    ...
    public static final String UPDATE_GRID_DENSITY_PREFERENCE =
        "updateGridDensityVisibilityPreference";
  ...
  public static class ProductReviewSubRoute {
    ...
    public static final String GET_PRODUCT_REVIEWS_IN_BATCHES_GIVEN_PRODUCT_ID =
