 ...
 *
 * <p>This model is used for creating and updating purchase order information. Includes OrderSummary
 * (financial breakdown and fulfillment details) and Shipment data.
 *
...
public class PurchaseOrderRequestModel {
  ...
  private List<PurchaseOrderProductItem>
      products; // Required: list of products with price and quantity
  private Map<String, String>
      attachments; // Optional: max 30 attachments (key: fileName, value: base64 data)
  ...
  public static class OrderSummaryData {
    ...
    private LocalDateTime
        expectedDeliveryDate; // Optional (accepts both yyyy-MM-dd and yyyy-MM-dd'T'HH:mm:ss)

    private AddressRequestModel
        address; // Required: delivery/shipping address data (will check for duplicates before
    // creating)
  ...
  public static class ShipmentProductData {
    ...
    private BigDecimal
        allocatedPrice; // Required: custom price per unit for this product in this shipment
  }
