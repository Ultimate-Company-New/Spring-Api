...
class GetPackagesByPickupLocationIdTest extends PackageServiceTestBase {
  ...
  void getPackagesByPickupLocationId_s01_AllIdenticalPackages_Success() {
    ...
    List<springapi.models.databasemodels.PackagePickupLocationMapping> identicalMappings =
        new ArrayList<>();
    for (int i = 0; i < 5; i++) {
  ...
  void getPackagesByPickupLocationId_s03_ExtremePackageCount_Success() {
    ...
    List<springapi.models.databasemodels.PackagePickupLocationMapping> manyMappings =
        new ArrayList<>();
  ...
  void getPackagesByPickupLocationId_s05_ManyPackagesResult_Success() {
    ...
    List<springapi.models.databasemodels.PackagePickupLocationMapping> manyMappings =
        new ArrayList<>();
    for (int i = 0; i < 15; i++) {
      springapi.models.databasemodels.PackagePickupLocationMapping mapping =
