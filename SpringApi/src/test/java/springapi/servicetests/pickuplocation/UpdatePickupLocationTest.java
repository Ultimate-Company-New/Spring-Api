 ...
 * updates and mapping updates. Test Count: 41 tests
 */
...
class UpdatePickupLocationTest extends PickupLocationServiceTestBase {
  ...
  /**
   * Purpose: Verify successful update of pickup location. Expected Result: Pickup location is
   * updated and saved without exception. Assertions: Repository methods are called, logging is
   * performed.
   */
  @Test
  ...
  void updatePickupLocation_Success_Success() {
    ...
    stubPickupLocationRepositoryFindByIdAndClientId(
        TEST_PICKUP_LOCATION_ID, TEST_CLIENT_ID, existingPickupLocation);
  ...
  /**
   * Purpose: Verify updating ShipRocket ID persists correctly. Expected Result: ShipRocket ID is
   * updated. Assertions: Saved entity has new ShipRocket ID.
   */
  @Test
  ...
  void updatePickupLocation_UpdatesShipRocketId_Success() {
    ...
    stubPickupLocationRepositoryFindByIdAndClientId(
        TEST_PICKUP_LOCATION_ID, TEST_CLIENT_ID, existing);
    stubAddressRepositoryFindById(TEST_ADDRESS_ID, testAddress);
    stubAddressRepositorySave(testAddress);
    ...
    verify(pickupLocationRepository)
        .save(argThat(saved -> TEST_SHIPROCKET_ID.equals(saved.getShipRocketPickupLocationId())));
  }
  ...
  /**
   * Purpose: Test update with international address characters. Expected Result: UTF-8 characters
   * handled correctly. Assertions: Update succeeds with international characters.
   */
  @Test
  ...
  /**
   * Purpose: Reject update when ID is max long and not found. Expected Result: NotFoundException is
   * thrown. Assertions: Exception message contains ID.
   */
  @Test
  ...
  /**
   * Purpose: Reject update when ID is min long and not found. Expected Result: NotFoundException is
   * thrown. Assertions: Exception message contains ID.
   */
  @Test
  ...
  /**
   * Purpose: Verify update modifies only specified address fields. Expected Result: Only changed
   * fields are updated, others remain unchanged. Assertions: Update only modifies address nickname,
   * not entire address.
   */
  @Test
  ...
  /**
   * Purpose: Reject update when ID is negative and not found. Expected Result: NotFoundException is
   * thrown. Assertions: Exception message contains ID.
   */
  @Test
  ...
  /**
   * Purpose: Reject null address in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject null city in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject null country in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject null nickname in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Verify null phone is accepted as optional field in update. Expected Result: Update
  ...
  /**
   * Purpose: Reject null postal code in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Verify update throws for null request. Expected Result: NullPointerException is
   * thrown. Assertions: Exception is thrown.
   */
  @Test
  ...
  void updatePickupLocation_NullRequest_ThrowsBadRequestException() {
    ...
    BadRequestException ex =
        assertThrows(
            BadRequestException.class, () -> pickupLocationService.updatePickupLocation(null));
  ...
  /**
   * Purpose: Reject null state in update. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject null street address in update. Expected Result: BadRequestException is thrown.
   * Assertions: Message contains ER001.
   */
  @Test
  ...
  /**
   * Purpose: Test update with numeric postal code variation. Expected Result: Numeric postal codes
   * accepted. Assertions: Update succeeds with numeric postal code.
   */
  @Test
  ...
  /**
   * Purpose: Verify update preserves created timestamp (not modified). Expected Result: Created
   * timestamp remains unchanged after update. Assertions: testPickupLocation.getCreatedAt()
   * unchanged before and after update.
   */
  @Test
  ...
  void updatePickupLocation_PreservesCreatedTimestamp_Success() {
    ...
    verify(pickupLocationRepository)
        .save(argThat(location -> location.getPickupLocationId().equals(TEST_PICKUP_LOCATION_ID)));
  }

  /**
   * Purpose: Test update when repository returns null on save. Expected Result: Graceful handling
   * of null repository response. Assertions: Update handles null repository result.
   */
  @Test
  ...
  /**
   * Purpose: Test update with special characters in address. Expected Result: Special chars
   * preserved in address fields. Assertions: Update succeeds with special char address.
   */
  @Test
  ...
  /**
   * Purpose: Verify update calls repository with correct client ID. Expected Result: Repository
   * method called with exact clientId. Assertions: Verify method call includes client isolation
   * parameter.
   */
  @Test
  ...
  /**
   * Purpose: Test update with very large pickup location ID. Expected Result: Large ID value
   * handled correctly. Assertions: Update succeeds with large ID.
   */
  @Test
  ...
  void updatePickupLocation_VeryLargeId_Success() {
    ...
    stubPickupLocationRepositoryFindByIdAndClientId(largeId, TEST_CLIENT_ID, testPickupLocation);
    stubAddressRepositorySave(testAddress);
    stubPickupLocationRepositorySave(testPickupLocation);
  ...
  /**
   * Purpose: Test update with very long nickname (boundary). Expected Result: Long nickname
   * accepted within system limits. Assertions: Update succeeds with extended length nickname.
   */
  @Test
  ...
  /**
   * Purpose: Verify whitespace phone is trimmed and accepted in update. Expected Result: Update
   * succeeds. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Reject update when ID is zero and not found. Expected Result: NotFoundException is
   * thrown. Assertions: Exception message contains ID.
   */
  @Test
  ...
  void updatePickupLocation_controller_permission_unauthorized() throws Exception {
    ...
    ResponseEntity<?> response =
        controller.updatePickupLocation(TEST_PICKUP_LOCATION_ID, testPickupLocationRequest);
  ...
  /**
   * Purpose: Verify controller delegates updatePickupLocation to service. Expected Result: Service
   * method called and status OK returned. Assertions: Delegation occurs and response is HTTP 200.
   */
  @Test
