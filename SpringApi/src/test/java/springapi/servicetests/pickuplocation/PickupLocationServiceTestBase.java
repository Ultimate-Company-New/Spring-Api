...
/**
 * Base test class for PickupLocationService tests. Contains common mocks, dependencies, and setup
 * logic shared across all PickupLocationService test classes.
 */
...
abstract class PickupLocationServiceTestBase {
  ...
  @Mock protected ProductPickupLocationMappingRepository productMappingRepository;

  @Mock protected PackagePickupLocationMappingRepository packageMappingRepository;
  ...
  @Mock protected PickupLocationFilterQueryBuilder pickupLocationFilterQueryBuilder;

  @Mock protected HttpServletRequest request;

  @Mock protected Authorization authorization;

  @InjectMocks protected PickupLocationService pickupLocationService;

  @Mock protected PickupLocationService pickupLocationServiceMock;
  ...
  /**
   * Sets up all common stubs needed for successful pickup location creation. Call this in success
   * tests to avoid repetitive stub setup.
   */
  ...
  protected void stubPickupLocationRepositoryFindByIdAndClientId(
      Long pickupLocationId, Long clientId, PickupLocation pickupLocation) {
    lenient()
        .when(
            pickupLocationRepository.findPickupLocationByIdAndClientId(pickupLocationId, clientId))
        .thenReturn(pickupLocation);
  }

  /** Stub for pickupLocationRepository.findPickupLocationByIdAndClientId returning null */
  protected void stubPickupLocationRepositoryFindByIdAndClientIdNotFound(
      Long pickupLocationId, Long clientId) {
    lenient()
        .when(
            pickupLocationRepository.findPickupLocationByIdAndClientId(pickupLocationId, clientId))
        .thenReturn(null);
  ...
  protected void stubPickupLocationRepositorySave(PickupLocation pickupLocation) {
    lenient()
        .when(pickupLocationRepository.save(any(PickupLocation.class)))
        .thenReturn(pickupLocation);
  }
  ...
  protected void stubShipRocketHelperAddPickupLocation(AddPickupLocationResponseModel response) {
    lenient()
        .when(shipRocketHelper.addPickupLocation(any(PickupLocation.class)))
        .thenReturn(response);
  }
  ...
  /** Stub for pickupLocationFilterQueryBuilder.findPaginatedEntitiesWithMultipleFilters */
  ...
  protected void stubPickupLocationFilterQueryBuilderGetColumnType(
      String column, String columnType) {
    lenient()
        .when(pickupLocationFilterQueryBuilder.getColumnType(eq(column)))
  ...
  protected void stubPickupLocationServiceGetPickupLocationByIdReturns(
      springapi.models.responsemodels.PickupLocationResponseModel result) {
  ...
  protected void stubPickupLocationServiceGetPickupLocationsInBatchesReturns(
      springapi.models.responsemodels.PaginationBaseResponseModel<
              springapi.models.responsemodels.PickupLocationResponseModel>
          result) {
  ...
  protected void stubProductMappingRepositoryCountByPickupLocationIds(
      java.util.List<Object[]> counts) {
  ...
  protected void stubPackageMappingRepositoryCountByPickupLocationIds(
      java.util.List<Object[]> counts) {
