...
class CreateUserGroupTest extends UserGroupServiceTestBase {
  ...
  /**
   * Purpose: Verify long description is allowed. Expected Result: No exception thrown, save is
   * called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify many users can be added to group. Expected Result: No exception thrown, save is
   * called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify single user group creation. Expected Result: No exception thrown, save is
   * called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify special characters in group name are allowed. Expected Result: No exception
   * thrown, save is called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify successful create operation. Expected Result: No exception thrown, repos save
   * called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify unicode characters in group name are allowed. Expected Result: No exception
   * thrown, save is called. Assertions: assertDoesNotThrow, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify user-group mappings are saved. Expected Result: saveAll is called on
   * userGroupUserMapRepository. Assertions: verify
   */
  @Test
  ...
  /**
   * Purpose: Verify repository save method is called. Expected Result: save is called on
   * userGroupRepository. Assertions: verify
   */
  @Test
  ...
  /**
   * Purpose: Verify empty description throws BadRequestException. Expected Result:
   * BadRequestException with ER003 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify empty group name throws BadRequestException. Expected Result:
   * BadRequestException with ER002 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify duplicate group name throws BadRequestException. Expected Result:
   * BadRequestException with GroupNameExists message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify no users throws BadRequestException. Expected Result: BadRequestException with
   * ER004 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify null description throws BadRequestException. Expected Result:
   * BadRequestException with ER003 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify null group name throws BadRequestException. Expected Result:
   * BadRequestException with ER002 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify null request throws NullPointerException. Expected Result: NullPointerException
  ...
  void createUserGroup_nullRequest_throwsNullPointerException() {
    ...
    NullPointerException ex =
        assertThrows(NullPointerException.class, () -> userGroupService.createUserGroup(null));
    ...
    assertTrue(
        ex.getMessage()
            .contains(springapi.models.requestmodels.UserGroupRequestModel.class.getSimpleName()));
  }

  /**
   * Purpose: Verify null user list throws BadRequestException. Expected Result: BadRequestException
   * with ER004 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify whitespace-only group name throws BadRequestException. Expected Result:
   * BadRequestException with ER002 message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  void createUserGroup_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    Method method =
        UserGroupController.class.getMethod("createUserGroup", UserGroupRequestModel.class);
    ...
    assertNotNull(
        annotation, "@PreAuthorize annotation should be present on createUserGroup method");
    assertTrue(
