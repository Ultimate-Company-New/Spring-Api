 ...
 *
 * <p>Provides common setup, mocks, and test data used across all UserGroupService test classes. All
 * UserGroupService test classes should extend this base class to inherit the common setup.
 *
...
abstract class UserGroupServiceTestBase {
  ...
  @Mock protected UserGroupRepository userGroupRepository;

  @Mock protected UserGroupUserMapRepository userGroupUserMapRepository;

  @Mock protected UserGroupFilterQueryBuilder userGroupFilterQueryBuilder;
  ...
  @Spy @InjectMocks protected UserGroupService userGroupService;

  @Mock protected UserGroupService mockUserGroupService;
  ...
  protected static final String[] STRING_COLUMNS = {
    "groupName", "description", "notes", "createdUser", "modifiedUser"
  };
  ...
  protected void stubFetchUserGroupsInClientInBatches(
      PaginationBaseResponseModel<UserGroupResponseModel> response) {
    doReturn(response)
        .when(userGroupService)
        .fetchUserGroupsInClientInBatches(any(UserGroupRequestModel.class));
  }
  ...
  protected void stubUserGroupRepositoryFindByGroupNameForPartialFailure(
      String validName, String duplicateName) {
  ...
  protected void stubUserGroupRepositorySaveWithException() {
    lenient()
        .when(userGroupRepository.save(any()))
  ...
  protected void stubMockUserGroupServiceGetUserGroupDetailsById(
      Long groupId, UserGroupResponseModel result) {
  ...
  protected void stubMockUserGroupServiceFetchUserGroupsInClientInBatches(
    ...
    lenient()
        .when(
            mockUserGroupService.fetchUserGroupsInClientInBatches(any(UserGroupRequestModel.class)))
        .thenReturn(result);
  }
