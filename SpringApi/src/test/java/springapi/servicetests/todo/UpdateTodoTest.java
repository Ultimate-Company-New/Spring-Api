...
class UpdateTodoTest extends TodoServiceTestBase {
  ...
  void updateTodo_emptyTask_badRequestException() {
    ...
    BadRequestException ex =
        assertThrows(BadRequestException.class, () -> todoService.updateTodo(request));
  ...
  void updateTodo_maxLongTodoId_notFoundException() {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> todoService.updateTodo(request));
  ...
  void updateTodo_nullRequest_badRequestException() {
    ...
    assertThrowsBadRequest(
        ErrorMessages.TodoErrorMessages.INVALID_REQUEST, () -> todoService.updateTodo(request));
  }
  ...
  void updateTodo_nullTask_badRequestException() {
    ...
    // Act & Assert
    assertThrowsBadRequest(
        ErrorMessages.TodoErrorMessages.INVALID_TASK, () -> todoService.updateTodo(request));
  }
