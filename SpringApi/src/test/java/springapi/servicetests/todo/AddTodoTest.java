...
class AddTodoTest extends TodoServiceTestBase {
  ...
  void addTodo_emptyTask_badRequestException() {
    ...
    BadRequestException ex =
        assertThrows(BadRequestException.class, () -> todoService.addTodo(request));
  ...
  void addTodo_nullRequest_badRequestException() {
    ...
    assertThrowsBadRequest(
        ErrorMessages.TodoErrorMessages.INVALID_REQUEST, () -> todoService.addTodo(request));
  }
  ...
  void addTodo_nullTask_badRequestException() {
    ...
    // Act & Assert
    assertThrowsBadRequest(
        ErrorMessages.TodoErrorMessages.INVALID_TASK, () -> todoService.addTodo(request));
  }
