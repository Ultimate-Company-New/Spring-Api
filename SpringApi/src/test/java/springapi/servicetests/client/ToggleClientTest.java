...
class ToggleClientTest extends ClientServiceTestBase {
  ...
  void toggleClient_ClientNotFound_Exception() {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> clientService.toggleClient(TEST_CLIENT_ID));
  ...
  void toggleClient_MaxLongId_Exception() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> clientService.toggleClient(Long.MAX_VALUE));
  ...
  void toggleClient_MinLongId_Exception() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> clientService.toggleClient(Long.MIN_VALUE));
  ...
  void toggleClient_NegativeId_Exception() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> clientService.toggleClient(negativeId));
  ...
  void toggleClient_ZeroId_Exception() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> clientService.toggleClient(zeroId));
  ...
  void toggleClient_p03_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    // Assert
    assertNotNull(
        preAuthorizeAnnotation, "toggleClient method should have @PreAuthorize annotation");
