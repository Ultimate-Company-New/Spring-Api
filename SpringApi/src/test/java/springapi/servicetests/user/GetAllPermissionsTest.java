...
class GetAllPermissionsTest extends UserServiceTestBase {
  ...
  /**
   * Purpose: Verify empty list is returned when all permissions are deleted. Expected Result:
   * Returns empty list. Assertions: assertTrue
   */
  @Test
  ...
  /**
   * Purpose: Verify empty list is returned when no permissions exist. Expected Result: Returns
   * empty list. Assertions: assertTrue
   */
  @Test
  ...
  /**
   * Purpose: Verify that the deleted permissions are filtered out. Expected Result: Returns only
   * non-deleted permissions. Assertions: assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify successful retrieval of all non-deleted permissions. Expected Result: Returns
   * list of non-deleted permissions. Assertions: assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify permissions are sorted by permission ID in ascending order. Expected Result:
   * Returns permissions sorted by ID. Assertions: assertEquals
   */
  @Test
