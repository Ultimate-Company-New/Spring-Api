...
/**
 * Test class for LeadService.createLead() method. Tests lead creation with various validation
 * scenarios. * Test Count: 33 tests
 */
...
class CreateLeadTest extends LeadServiceTestBase {
  ...
  /**
   * Purpose: Verify creation succeeds with the maximum possible integer for company size. Expected
   * Result: Lead is saved with the provided company size. Assertions: Repository save is invoked
  ...
  /**
   * Purpose: Verify creation succeeds with special characters in the lead's name. Expected Result:
   * Lead is saved successfully with characters like accents and hyphens. Assertions: Process
  ...
  /**
   * Purpose: Verify basic successful lead creation with a valid request. Expected Result: Lead is
   * saved and success is logged. Assertions: Repository save and user log calls occur.
   */
  @Test
  ...
  /**
   * Purpose: Verify creation succeeds with Unicode characters in name fields. Expected Result:
   * Non-Latin characters are preserved and lead is saved. Assertions: No exception occurs during
   * the save process.
   */
  @Test
  ...
  /**
   * Purpose: Verify creation succeeds with a valid company string. Expected Result: Company field
   * is persisted. Assertions: Repository save is invoked.
   */
  @Test
  ...
  /**
   * Purpose: Verify creation succeeds with a valid job title. Expected Result: Title field is
   * persisted correctly. Assertions: Lead creation does not throw an exception.
   */
  @Test
  ...
  /**
   * Purpose: Verify system handles extremely long email addresses within valid format. Expected
   * Result: Save completes successfully. Assertions: No validation error triggered for email
   * length.
   */
  @Test
  ...
  /**
   * Purpose: Reject lead creation with an empty email string. Expected Result: BadRequestException
   * is thrown. Assertions: Error message matches ER001.
   */
  ...
  void createLead_emptyRequiredFields_ThrowsBadRequestException(
      String scenario,
      Consumer<springapi.models.requestmodels.LeadRequestModel> mutator,
    ...
    BadRequestException ex =
        assertThrows(BadRequestException.class, () -> leadService.createLead(testLeadRequest));
  ...
  private static Stream<Arguments> emptyRequiredFieldScenarios() {
    return Stream.of(
        Arguments.of(
            "Empty Email",
            (Consumer<springapi.models.requestmodels.LeadRequestModel>) req -> req.setEmail(""),
            ErrorMessages.LeadsErrorMessages.ER001),
        Arguments.of(
            "Empty First Name",
            (Consumer<springapi.models.requestmodels.LeadRequestModel>) req -> req.setFirstName(""),
            ErrorMessages.LeadsErrorMessages.ER002),
        Arguments.of(
            "Empty Last Name",
            (Consumer<springapi.models.requestmodels.LeadRequestModel>) req -> req.setLastName(""),
            ErrorMessages.LeadsErrorMessages.ER003),
        Arguments.of(
            "Empty Phone",
            (Consumer<springapi.models.requestmodels.LeadRequestModel>) req -> req.setPhone(""),
            ErrorMessages.LeadsErrorMessages.ER004),
        Arguments.of(
            "Empty Status",
            (Consumer<springapi.models.requestmodels.LeadRequestModel>)
                req -> req.setLeadStatus(""),
            ErrorMessages.LeadsErrorMessages.ER008));
  }

  /**
   * Purpose: Reject invalid email formats (missing @, etc.). Expected Result: BadRequestException
   * is thrown. Assertions: Error message matches ER010.
   */
  @Test
  ...
  /**
   * Purpose: Reject invalid phone formats. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject unknown lead statuses. Expected Result: BadRequestException is thrown with
   * allowed values. Assertions: Error message contains ER007.
   */
  @Test
  ...
  /**
   * Purpose: Reject requests missing both nested address and address ID. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER013.
   */
  @Test
  ...
  /**
   * Purpose: Reject negative integers for company size. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER016.
   */
  @Test
  ...
  /**
   * Purpose: Reject lead creation when email is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER001.
   */
  @Test
  ...
  /**
   * Purpose: Reject lead creation when first name is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER002.
   */
  @Test
  ...
  /**
   * Purpose: Reject lead creation when last name is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER003.
   */
  @Test
  ...
  /**
   * Purpose: Reject lead creation when phone is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER004.
   */
  @Test
  ...
  /**
   * Purpose: Reject creation when the entire request model is null. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER009.
   */
  @Test
  ...
  /**
   * Purpose: Reject creation when lead status is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER008.
   */
  @Test
  ...
  /**
   * Purpose: Reject email strings consisting only of whitespace. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER001.
   */
  @Test
  ...
  /**
   * Purpose: Reject first name strings consisting only of whitespace. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER002.
   */
  @Test
  ...
  /**
   * Purpose: Reject last name strings consisting only of whitespace. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER003.
   */
  @Test
  ...
  /**
   * Purpose: Reject phone strings consisting only of whitespace. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER004.
   */
  @Test
  ...
  /**
   * Purpose: Reject status strings consisting only of whitespace. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER008.
   */
  @Test
  ...
  /**
   * Purpose: Reject zero as a company size value. Expected Result: BadRequestException is thrown
   * (size must be null or > 0). Assertions: Error message matches ER016.
   */
  @Test
  ...
  /**
   * Purpose: Verify controller delegates createLead calls to service. Expected Result: Service
   * method called and HTTP 200 returned.
   */
  @Test
