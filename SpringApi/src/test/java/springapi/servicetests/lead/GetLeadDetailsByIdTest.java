...
class GetLeadDetailsByIdTest extends LeadServiceTestBase {
  ...
  void getLeadDetailsById_unit_maxLongId_notFound() {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.getLeadDetailsById(Long.MAX_VALUE));
  ...
  void getLeadDetailsById_unit_minLongId_notFound() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.getLeadDetailsById(Long.MIN_VALUE));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }
  ...
  void getLeadDetailsById_unit_negativeId_notFound() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.getLeadDetailsById(-1L));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }
  ...
  void getLeadDetailsById_unit_notFound_failure() {
    ...
    NotFoundException ex =
        assertThrows(
            NotFoundException.class, () -> leadService.getLeadDetailsById(DEFAULT_LEAD_ID));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }
  ...
  void getLeadDetailsById_unit_zeroId_notFound() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.getLeadDetailsById(0L));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }
