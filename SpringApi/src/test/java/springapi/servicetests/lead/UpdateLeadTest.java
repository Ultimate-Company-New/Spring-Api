...
/**
 * Test class for LeadService.updateLead() method. Tests lead updates with various validation
...
class UpdateLeadTest extends LeadServiceTestBase {
  ...
  /**
   * Purpose: Verify successful update when all fields are changed. Expected Result: Lead is
   * persisted with all new data. Assertions: Repository save is invoked with the updated model.
   */
  @Test
  ...
  /**
   * Purpose: Verify partial updates (patch-like) only change provided fields and persist. Given:
   * Existing lead and update DTO with phone number change When: updateLead is called Then: Lead is
   * persisted with update
   */
  @Test
  ...
  /**
   * Purpose: Verify update succeeds with special characters in field values. Expected Result:
   * Non-standard characters are handled correctly. Assertions: Process completes without error.
   */
  @Test
  ...
  /**
   * Purpose: Verify basic successful update scenario. Expected Result: Existing lead is found and
   * saved. Assertions: Repository save and address save occur.
   */
  @Test
  ...
  /**
   * Purpose: Verify update succeeds with very long name values. Expected Result: Long strings are
   * persisted successfully. Assertions: Repository save is invoked.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates for leads already marked as deleted. Expected Result: NotFoundException
   * is thrown. Assertions: Error message matches expectations.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates Consisting of an empty email string. Expected Result:
  ...
  /**
   * Purpose: Reject updates with an empty first name. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject updates with an empty last name. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject updates with an empty phone string. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject updates with an empty status string. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject update with an invalid email format. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject update with an invalid phone format. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches expectations.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates to an unknown lead status. Expected Result: BadRequestException is
   * thrown. Assertions: Error message contains ER007.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates for negative lead IDs. Expected Result: NotFoundException is thrown.
  ...
  void updateLead_NegativeId_ThrowsNotFoundException() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.updateLead(-1L, testLeadRequest));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }

  /**
   * Purpose: Reject updates when the lead ID does not exist. Expected Result: NotFoundException is
   * thrown. Assertions: Error message matches LEAD_NOT_FOUND.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates when the request email is null. Expected Result: BadRequestException is
  ...
  /**
   * Purpose: Reject updates when first name is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER002.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates when last name is null. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject updates when phone is null. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject updates when the entire request model is null. Expected Result:
  ...
  void updateLead_NullRequest_ThrowsBadRequestException() {
    ...
    BadRequestException ex =
        assertThrows(
            BadRequestException.class, () -> leadService.updateLead(DEFAULT_LEAD_ID, null));
    assertEquals(ErrorMessages.LeadsErrorMessages.ER009, ex.getMessage());
  }

  /**
   * Purpose: Reject updates when lead status is null. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches ER008.
   */
  @Test
  ...
  /**
   * Purpose: Reject updates Consisting of a company size of zero. Expected Result:
   * BadRequestException is thrown. Assertions: Error message matches ER016.
   */
  @Test
  ...
  /**
   * Purpose: Reject zero as a lead ID. Expected Result: NotFoundException is thrown. Assertions:
   * Error message matches LEAD_NOT_FOUND.
   */
  @Test
  ...
  void updateLead_ZeroId_ThrowsNotFoundException() {
    ...
    // Act & Assert
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> leadService.updateLead(0L, testLeadRequest));
    assertEquals(ErrorMessages.LEAD_NOT_FOUND, ex.getMessage());
  }
