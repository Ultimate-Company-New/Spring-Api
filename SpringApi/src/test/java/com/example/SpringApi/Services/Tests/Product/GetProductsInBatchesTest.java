...
public class GetProductsInBatchesTest extends ProductServiceTestBase {
        ...
        for (String column : allColumns) {
            for (String operator : uniqueOperators) {
                for (String value : allValues) {
                    ...
                    PaginationBaseRequestModel.FilterCondition filter = createFilterCondition(column, operator, value);
    ...
    void getProductInBatches_VerifyPreAuthorizeAnnotation() throws NoSuchMethodException {
        Method method = ProductController.class.getMethod("getProductInBatches", PaginationBaseRequestModel.class);
    ...
    void getProductInBatches_WithValidRequest_DelegatesToService() {
        ...
        when(productService.getProductInBatches(request)).thenReturn(mockResponse);

        ResponseEntity<?> response = controller.getProductInBatches(request);

        verify(productService).getProductInBatches(request);
