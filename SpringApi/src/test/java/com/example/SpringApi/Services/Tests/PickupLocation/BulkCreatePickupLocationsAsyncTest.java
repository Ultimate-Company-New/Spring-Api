...
//        List<PickupLocationRequestModel> requests = new ArrayList<>();
//
//        PickupLocationRequestModel req1 = createValidPickupLocationRequest(1L, TEST_CLIENT_ID);
//        req1.setAddressNickName("São Paulo Hub");
//        requests.add(req1);
//
//        PickupLocationRequestModel req2 = createValidPickupLocationRequest(2L, TEST_CLIENT_ID);
...
//     */
//    @Test
//    @DisplayName("Bulk Create Pickup Locations Async - Null List - Throws BadRequestException")
//    void bulkCreatePickupLocationsAsync_NullList_ThrowsBadRequestException() {
//        // ARRANGE & ACT & ASSERT
...
//     */
//    @Test
//    @DisplayName("Bulk Create Pickup Locations Async - Empty List - Throws BadRequestException")
//    void bulkCreatePickupLocationsAsync_EmptyList_ThrowsBadRequestException() {
//        // ARRANGE
...
//        List<PickupLocationRequestModel> requests = new ArrayList<>();
//        requests.add(createValidPickupLocationRequest(1L, differentClientId));
//
//        when(addressRepository.save(any())).thenReturn(testAddress);
//        when(pickupLocationRepository.save(any())).thenReturn(testPickupLocation);
//        lenient().when(shippingHelper.addPickupLocation(any())).thenReturn(testShipRocketResponse);
...
//        // ARRANGE & ACT
//        Method method = PickupLocationController.class.getMethod("bulkCreatePickupLocationsAsync",
//                List.class);
//        PreAuthorize annotation = method.getAnnotation(PreAuthorize.class);
//
//        // ASSERT
//        assertNotNull(annotation, "@PreAuthorize annotation should be present on bulkCreatePickupLocationsAsync");
//        assertTrue(annotation.value().contains(Authorizations.CREATE_PICKUP_LOCATIONS_PERMISSION),
//                "@PreAuthorize should reference CREATE_PICKUP_LOCATIONS_PERMISSION");
//    }
//
//    @Test
//    @DisplayName("bulkCreatePickupLocationsAsync - Method Is Void Return Type")
//    void bulkCreatePickupLocationsAsync_MethodIsVoidReturnType() throws NoSuchMethodException {
//        // ARRANGE & ACT
//        Method method = PickupLocationController.class.getMethod("bulkCreatePickupLocationsAsync",
//                List.class);
...
//
//        // ASSERT
//        assertEquals(void.class, returnType, "bulkCreatePickupLocationsAsync should return void (async processing)");
//    }
//}
