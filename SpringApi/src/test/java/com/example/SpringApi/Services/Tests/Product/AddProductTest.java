...
class AddProductTest extends ProductServiceTestBase {
    ...
    void addProduct_CategoryNotFound_ThrowsNotFound() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class,
                () -> productService.addProduct(testProductRequest));
        assertEquals(String.format(ErrorMessages.ProductErrorMessages.ER008, TEST_CATEGORY_ID),
    ...
    void addProduct_MalformedUrl_ThrowsBadRequest() {
        ...
        BadRequestException exception = assertThrows(BadRequestException.class,
                () -> productService.addProduct(testProductRequest));
        assertEquals(String.format(ErrorMessages.ProductErrorMessages.ER012, "httptest://invalid-url"), exception.getMessage()); // URL processing failure
    }
