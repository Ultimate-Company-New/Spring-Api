...
public abstract class MessageServiceTestBase {
    ...
    protected void stubMessageRepositoryFindByMessageIdAndClientId(Optional<Message> message) {
        lenient().when(messageRepository.findByMessageIdAndClientId(anyLong(), anyLong())).thenReturn(message);
    }

    /**
     * Stub messageRepository.findByMessageIdAndClientIdIncludingDeleted.
     */
    protected void stubMessageRepositoryFindByMessageIdAndClientIdIncludingDeleted(Optional<Message> message) {
        lenient().when(messageRepository.findByMessageIdAndClientIdIncludingDeleted(anyLong(), anyLong()))
                .thenReturn(message);
    }
     ...
     */
    protected void stubMessageRepositoryFindByMessageIdAndClientIdWithTargets(Optional<Message> message) {
        lenient().when(messageRepository.findByMessageIdAndClientIdWithTargets(anyLong(), anyLong()))
                .thenReturn(message);
    }
     ...
     */
    protected void stubMessageRepositoryFindPaginatedMessages(org.springframework.data.domain.Page<Message> page) {
        lenient().when(messageRepository.findPaginatedMessages(anyLong(), any(), any(), any(), anyBoolean(),
     ...
     */
    protected void stubMessageRepositoryFindMessagesByUserIdPaginated(org.springframework.data.domain.Page<Message> page) {
        lenient().when(messageRepository.findMessagesByUserIdPaginated(anyLong(), anyLong(),
                any(org.springframework.data.domain.Pageable.class))).thenReturn(page);
    }
    ...
    protected void stubMessageRepositoryFindMessagesByUserIdPaginatedThrows(String message) {
        lenient().when(messageRepository.findMessagesByUserIdPaginated(anyLong(), anyLong(),
                any(org.springframework.data.domain.Pageable.class))).thenThrow(new RuntimeException(message));
    }
    ...
    protected void stubMessageRepositoryCountUnreadMessagesByUserId(Long count) {
        lenient().when(messageRepository.countUnreadMessagesByUserId(anyLong(), anyLong())).thenReturn(count);
    }
    ...
    protected void stubMessageRepositoryCountUnreadMessagesByUserIdThrows(String message) {
        lenient().when(messageRepository.countUnreadMessagesByUserId(anyLong(), anyLong()))
                .thenThrow(new RuntimeException(message));
    }
    ...
    protected void stubUserRepositoryFindAllUserEmails(List<String> emails) {
        lenient().when(userRepository.findAllUserEmailsByClientAndUserIdsAndGroupIds(anyLong(), anyList(), anyList()))
                .thenReturn(emails);
    }
    ...
    protected void stubUserRepositoryFindByUserIdAndClientIdThrows(String message) {
        lenient().when(userRepository.findByUserIdAndClientId(anyLong(), anyLong()))
                .thenThrow(new RuntimeException(message));
    }
    ...
    protected void stubMessageUserGroupMapRepositorySave(MessageUserGroupMap map) {
        lenient().when(messageUserGroupMapRepository.save(any(MessageUserGroupMap.class))).thenReturn(map);
    }
    ...
    protected void stubMessageUserReadMapRepositoryFindByMessageIdAndUserId(MessageUserReadMap map) {
        lenient().when(messageUserReadMapRepository.findByMessageIdAndUserId(anyLong(), anyLong())).thenReturn(map);
    }

    /**
     * Stub messageUserReadMapRepository.findByMessageIdAndUserId for specific IDs.
     */
    protected void stubMessageUserReadMapRepositoryFindByMessageIdAndUserId(Long messageId, Long userId,
            MessageUserReadMap map) {
        lenient().when(messageUserReadMapRepository.findByMessageIdAndUserId(messageId, userId)).thenReturn(map);
    }
    ...
    protected void stubMessageUserReadMapRepositorySave(MessageUserReadMap map) {
        lenient().when(messageUserReadMapRepository.save(any(MessageUserReadMap.class))).thenReturn(map);
    }
    ...
    protected org.mockito.MockedConstruction<EmailHelper> stubEmailHelperCancelEmail() {
        return mockConstruction(EmailHelper.class,
     ...
     */
    protected org.mockito.MockedConstruction<EmailHelper> stubEmailHelperGenerateBatchId(String batchId) {
        return mockConstruction(EmailHelper.class,
     ...
     */
    protected org.mockito.MockedConstruction<EmailTemplates> stubEmailTemplatesSendEmail(boolean result) {
        return mockConstruction(EmailTemplates.class,
            (mock, context) -> lenient().when(mock.sendMessageEmail(anyList(), anyString(), anyString(), any(java.time.LocalDateTime.class), anyString()))
                .thenReturn(result));
    }
    ...
    protected void stubMessageServiceUpdateMessageThrowsUnauthorized() {
        lenient().doThrow(new com.example.SpringApi.Exceptions.UnauthorizedException(ErrorMessages.ERROR_UNAUTHORIZED))
                .when(messageServiceMock).updateMessage(any(MessageRequestModel.class));
    }
     ...
     */
    protected void stubMessageServiceGetMessageDetailsById(com.example.SpringApi.Models.ResponseModels.MessageResponseModel response) {
    ...
    protected void stubMessageServiceGetMessagesInBatches(
            com.example.SpringApi.Models.ResponseModels.PaginationBaseResponseModel<com.example.SpringApi.Models.ResponseModels.MessageResponseModel> response) {
        lenient().when(messageServiceMock.getMessagesInBatches(any(
                com.example.SpringApi.Models.RequestModels.PaginationBaseRequestModel.class))).thenReturn(response);
    }
    ...
    protected void stubMessageServiceGetMessagesByUserId(
            com.example.SpringApi.Models.ResponseModels.PaginationBaseResponseModel<com.example.SpringApi.Models.ResponseModels.MessageResponseModel> response) {
        lenient().when(messageServiceMock.getMessagesByUserId(any(
                com.example.SpringApi.Models.RequestModels.PaginationBaseRequestModel.class))).thenReturn(response);
    }
    ...
    protected void stubMessageServiceSetMessageReadByUserIdAndMessageIdDoNothing() {
        lenient().doNothing().when(messageServiceMock).setMessageReadByUserIdAndMessageId(anyLong(), anyLong());
    }
