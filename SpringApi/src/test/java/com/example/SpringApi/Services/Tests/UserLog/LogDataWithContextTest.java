...
class LogDataWithContextTest extends UserLogServiceTestBase {
    ...
    void logDataWithContext_differentUserContext_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(differentUserId, differentUsername, differentClientId,
                "test value", TEST_ENDPOINT);
    ...
    void logDataWithContext_emptyUsername_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, "", TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_maxLongClientId_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, "admin", Long.MAX_VALUE, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_maxLongUserId_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(Long.MAX_VALUE, "admin", TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_negativeUserId_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(-1L, "admin", TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_nullUsername_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, null, TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_specialCharsUsername_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, "user@domain.com", TEST_CARRIER_ID,
                TEST_NEW_VALUE, TEST_ENDPOINT);
    ...
    void logDataWithContext_success_basic() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, "testuser", TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_unicodeUsername_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, "用户名", TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
    ...
    void logDataWithContext_veryLongUsername_success() {
        ...
        // Act
        Boolean result = userLogService.logDataWithContext(TEST_USER_ID, longUsername, TEST_CARRIER_ID, TEST_NEW_VALUE,
                TEST_ENDPOINT);
