...
//         * Assertions: testPickupLocation.getCreatedAt() unchanged before and after update.
//         */
//        @Test
...
//                verify(pickupLocationRepository).save(argThat(location ->
//                        location.getPickupLocationId().equals(TEST_PICKUP_LOCATION_ID)));
//        }
//
//        /**
...
//                // ASSERT
//                verify(pickupLocationRepository).save(argThat(location ->
//                        location.getAddressNickName().equals(newNickname)));
//        }
//
//        /**
...
//                // ARRANGE
//                String longNickname = "Regional Distribution Center - Primary Location for All Domestic Shipments - Main Hub";
