...
class ShippingRequestModelsTest {
    ...
    void shipRocketOrderRequestModel_Serialization_UsesUnderscoreNames() {
        ...
        model.setOrderItems(List.of(new ShipRocketOrderRequestModel.OrderItem("Item1", "SKU1", 2, 500, 10, 18)));
    ...
    void shipRocketReturnOrderRequestModel_Serialization_UsesUnderscoreNames() {
        ...
        ShipRocketReturnOrderRequestModel.ReturnOrderItem item = new ShipRocketReturnOrderRequestModel.ReturnOrderItem();
    ...
    void shipRocketReturnOrderRequestModel_Deserialization_MapsUnderscoreToCamelCase() {
        ...
        ShipRocketReturnOrderRequestModel parsed = gson.fromJson(json, ShipRocketReturnOrderRequestModel.class);
    ...
    void createReturnRequestModel_JacksonRoundTrip_PreservesNestedFields() throws Exception {
        ...
        CreateReturnRequestModel.ReturnProductItem item = new CreateReturnRequestModel.ReturnProductItem();
    ...
    @Test
    void shippingCalculationRequestModel_JacksonRoundTrip_PreservesPickupLocations() throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        ...
        String json = mapper.writeValueAsString(model);
        ShippingCalculationRequestModel parsed = mapper.readValue(json, ShippingCalculationRequestModel.class);
