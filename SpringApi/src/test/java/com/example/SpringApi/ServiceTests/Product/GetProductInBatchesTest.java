...
class GetProductInBatchesTest extends ProductServiceTestBase {
     ...
     * Expected Result: Query executed with includeDeleted = true.
     * Assertions: Filter query builder invoked with includeDeleted true.
     */
    @Test
     ...
     * Expected Result: Query executed with AND operator.
     * Assertions: Filter query builder invoked with AND logic.
     */
    @Test
     ...
     * Expected Result: Query executed with OR operator.
     * Assertions: Filter query builder invoked with OR logic.
     */
    @Test
     ...
     * Expected Result: Results returned for default request.
     * Assertions: Response contains product data.
     */
    @Test
    ...
    /**
     * Purpose: Verify failure on invalid operator for type.
