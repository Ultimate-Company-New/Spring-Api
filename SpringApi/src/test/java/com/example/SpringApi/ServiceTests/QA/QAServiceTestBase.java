...
abstract class QAServiceTestBase {
     ...
     */
    protected Object createServiceControllerMapping(String controllerName, String basePath, String testClassName) {
     ...
     */
    protected Object createQaPrivateInnerInstance(String innerSimpleName, Class<?>[] parameterTypes, Object... args) {
        try {
     ...
     */
    protected Object invokePrivateMethod(Object target, String methodName, Class<?>[] parameterTypes, Object... args) {
        try {
     ...
     */
    protected Object invokePrivateStaticMethod(Class<?> targetClass, String methodName, Class<?>[] parameterTypes,
            Object... args) {
        try {
