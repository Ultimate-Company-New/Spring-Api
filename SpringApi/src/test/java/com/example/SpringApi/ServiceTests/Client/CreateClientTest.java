...
class CreateClientTest extends ClientServiceTestBase {
  ...
  void createClient_WithImgbbLogo_Success() {
    ...
    ImgbbHelper.ImgbbUploadResponse mockResponse =
        new ImgbbHelper.ImgbbUploadResponse("http://imgbb.com/image.png", "deleteHash123");
  ...
  void createClient_DuplicateName_ThrowsBadRequestException() {
    ...
    BadRequestException ex =
        assertThrows(
            BadRequestException.class, () -> clientService.createClient(testClientRequest));
  ...
  void createClient_p03_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    // Assert
    assertNotNull(
        preAuthorizeAnnotation, "createClient method should have @PreAuthorize annotation");
