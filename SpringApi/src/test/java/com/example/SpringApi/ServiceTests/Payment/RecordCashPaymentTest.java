...
class RecordCashPaymentTest extends PaymentServiceTestBase {
    ...
    /**
     * Purpose: Verify recordCashPayment allows only PENDING_APPROVAL status.
     * Expected Result: BadRequestException with pending-approval status message.
     * Assertions: Exception type and exact message.
     */
    @Test
    ...
    /**
     * Purpose: Verify payment date is mandatory for manual cash payment recording.
    ...
    /**
     * Purpose: Verify positive amount is mandatory for manual cash payment recording.
    ...
    /**
     * Purpose: Verify payment amount cannot exceed pending amount from order summary.
     * Expected Result: BadRequestException with pending-amount exceeded message.
    ...
    void recordCashPayment_f12_amountExceedsPendingAmount_failure() {
        ...
        assertEquals(String.format(
                ...
                new BigDecimal("800.00")), ex.getMessage());
    }

    /**
     * Purpose: Verify UPI transaction id triggers UPI payment method and full-payment approval status update.
     * Expected Result: Success response with APPROVED status and captured payment saved as UPI.
     * Assertions: Response fields and saved payment method/test mode.
     */
    @Test
    ...
    void recordCashPayment_s02_upiPaymentFullApproval_success() {
        ...
        // Act
        PaymentVerificationResponseModel response = paymentService.recordCashPayment(testCashPaymentRequest);
