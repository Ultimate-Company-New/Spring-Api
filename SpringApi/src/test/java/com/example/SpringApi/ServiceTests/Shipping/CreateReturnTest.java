...
/**
    ...
    /**
     * Purpose: Verify warehouse nickname fallback is used when name on address is null.
     * Expected Result: ReturnShipmentResponseModel returned.
     * Assertions: Response is not null.
     */
    @Test
    ...
    void createReturn_RequestFallbackFields_Success() {
        ...
        // Assert
        assertNotNull(result);
        ArgumentCaptor<ShipRocketReturnOrderRequestModel> captor = ArgumentCaptor.forClass(ShipRocketReturnOrderRequestModel.class);
