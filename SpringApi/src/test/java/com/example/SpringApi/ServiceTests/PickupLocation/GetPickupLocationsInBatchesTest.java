...
class GetPickupLocationsInBatchesTest extends PickupLocationServiceTestBase {
    ...
    void getPickupLocationsInBatches_Comprehensive_Success() {
        ...
        void getPickupLocationsInBatches_MultipleResults_Success() {
                ...
                com.example.SpringApi.Models.DatabaseModels.PickupLocation location2 = new com.example.SpringApi.Models.DatabaseModels.PickupLocation();
        ...
        /**
         * Purpose: Reject null pagination request.
         * Expected Result: BadRequestException is thrown.
        ...
        /**
         * Purpose: Reject filter with invalid column name.
         * Expected Result: BadRequestException is thrown.
         * Assertions: Error message matches InvalidColumnNameFormat.
         */
        @Test
        @DisplayName("Get Pickup Locations In Batches - Invalid Filter Column - Throws BadRequestException")
        void getPickupLocationsInBatches_InvalidFilterColumn_ThrowsBadRequestException() {
                ...
                // Assert
                assertEquals(String.format(ErrorMessages.PickupLocationErrorMessages.INVALID_COLUMN_NAME_FORMAT,
                                "unknownColumn"), ex.getMessage());
        }

        /**
         * Purpose: Reject filter with invalid operator.
         * Expected Result: BadRequestException is thrown.
         * Assertions: Error message matches InvalidOperatorFormat.
         */
        @Test
        @DisplayName("Get Pickup Locations In Batches - Invalid Filter Operator - Throws BadRequestException")
        void getPickupLocationsInBatches_InvalidFilterOperator_ThrowsBadRequestException() {
                ...
                // Assert
                assertEquals(String.format(ErrorMessages.PickupLocationErrorMessages.INVALID_OPERATOR_FORMAT, "nope"),
                                ex.getMessage());
        }

        /**
         * Purpose: Reject filter with missing value for value-based operator.
         * Expected Result: Filter validation throws IllegalArgumentException.
         * Assertions: Exception message is not empty.
         */
        @Test
        @DisplayName("Get Pickup Locations In Batches - Filter Missing Value - Throws IllegalArgumentException")
        ...
        /**
         * Purpose: Verify product/package count maps are populated from batch count queries.
         * Expected Result: Response models include count values from repository aggregates.
         * Assertions: Product and package counts match aggregate rows.
         */
        @Test
