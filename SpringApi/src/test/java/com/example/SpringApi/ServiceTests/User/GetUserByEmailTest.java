...
class GetUserByEmailTest extends UserServiceTestBase {
  ...
  /**
   * Purpose: Verify case sensitivity in email lookup logic. Expected Result: Returns user when
   * email matches. Assertions: assertNotNull, verify
   */
  @Test
  ...
  /**
   * Purpose: Verify repository is called exactly once. Expected Result: findByEmailWithAllRelations
  ...
  /**
   * Purpose: Verify permissions are returned with email lookup. Expected Result: Permissions list
   * is populated. Assertions: assertNotNull, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify successful user retrieval by email. Expected Result: UserResponseModel is
   * returned with correct data. Assertions: assertNotNull, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify non-existent email throws NotFoundException. Expected Result: NotFoundException
   * with InvalidEmail message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  void getUserByEmail_emailNotFound_throwsNotFoundException() {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> userService.getUserByEmail(TEST_EMAIL));
  ...
  /**
   * Purpose: Verify empty email throws NotFoundException. Expected Result: NotFoundException with
   * InvalidEmail message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify invalid email format throws NotFoundException. Expected Result:
   * NotFoundException with InvalidEmail message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  void getUserByEmail_invalidFormat_throwsNotFoundException() {
    ...
    // Act
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> userService.getUserByEmail("not-an-email"));
  ...
  /**
   * Purpose: Verify null email throws NotFoundException. Expected Result: NotFoundException with
   * InvalidEmail message. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify whitespace email throws NotFoundException. Expected Result: NotFoundException
   * with InvalidEmail message. Assertions: assertThrows, assertEquals
   */
  @Test
