...
class GetEndpointsWithTestsByServiceTest extends QAServiceTestBase {
     ...
     * Expected Result: NotFoundException is thrown with class-loading message.
    ...
    void getEndpointsWithTestsByService_f16_mappedClassMissing_throwsNotFoundException() {
        ...
        Object mapping = createServiceControllerMapping("GhostController", "/api/Ghost", "GhostServiceTest");
        ...
        try {
            ...
            // Assert
            assertEquals(
                    String.format(ErrorMessages.QAErrorMessages.COULD_NOT_LOAD_SERVICE_CLASS_FORMAT, missingServiceName),
                    ex.getMessage());
        } finally {
