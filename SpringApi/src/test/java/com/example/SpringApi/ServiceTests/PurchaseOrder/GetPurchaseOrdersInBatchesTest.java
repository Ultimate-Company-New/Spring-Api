...
class GetPurchaseOrdersInBatchesTest extends PurchaseOrderServiceTestBase {
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for getPurchaseOrdersInBatches. Expected Result:
  ...
  void getPurchaseOrdersInBatches_VerifyPreAuthorizeAnnotation_Success()
      throws NoSuchMethodException {
    // Arrange
    Method method =
        PurchaseOrderController.class.getMethod(
            "getPurchaseOrdersInBatches", PaginationBaseRequestModel.class);
    ...
    // Assert
    assertNotNull(
        annotation, "@PreAuthorize annotation should be present on getPurchaseOrdersInBatches");
    assertTrue(
