...
class GetClientsByUserTest extends ClientServiceTestBase {
  ...
  @Test
  @DisplayName(
      "Get Clients By User - Repository throws DataAccessException - ThrowsDataAccessException")
  void getClientsByUser_RepositoryDataAccessException_ThrowsDataAccessException() {
    // Arrange
    stubClientFindByUserIdThrowsDataAccessException(
        TEST_USER_ID, ErrorMessages.CommonErrorMessages.DATABASE_ERROR);
  ...
  void getClientsByUser_RepositoryReturnsNull_ThrowsNullPointerException() {
    ...
    // Act & Assert
    assertThrows(NullPointerException.class, () -> clientService.getClientsByUser());
  }
  ...
  void getClientsByUser_RepositoryRuntimeException_ThrowsRuntimeException() {
    // Arrange
    stubClientFindByUserIdThrowsRuntimeException(
        TEST_USER_ID, ErrorMessages.CommonErrorMessages.DATABASE_CONNECTION_ERROR);

    // Act & Assert
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> clientService.getClientsByUser());
  ...
  void getClientsByUser_p03_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    // Assert
    assertNotNull(
        preAuthorizeAnnotation, "getClientsByUser method should have @PreAuthorize annotation");
