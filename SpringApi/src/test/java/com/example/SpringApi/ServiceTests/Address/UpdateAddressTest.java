...
class UpdateAddressTest extends AddressServiceTestBase {
  ...
  /**
   * Purpose: Verify updating an existing address succeeds. Expected Result: Address is saved and
   * log is written. Assertions: Save/log calls are invoked.
   */
  @Test
  ...
  /**
   * Purpose: Verify changing address type succeeds. Expected Result: Update succeeds. Assertions:
  ...
  /**
   * Purpose: Verify update logs success route with updated ID. Expected Result: Log entry includes
   * success message and route. Assertions: logData is called with UPDATE_ADDRESS route and success
   * text.
   */
  @Test
  ...
  /**
   * Purpose: Default boolean fields when null on update. Expected Result: isPrimary/isDeleted
  ...
  /**
   * Purpose: Verify update succeeds with null optional fields. Expected Result: Update succeeds.
  ...
  /**
   * Purpose: Preserve created fields on update. Expected Result: createdUser and createdAt remain
   * unchanged. Assertions: Saved address retains original created fields.
   */
  @Test
  ...
  /**
   * Purpose: Verify update succeeds with valid fields. Expected Result: Address is saved and log is
   * written. Assertions: Save and log calls are invoked.
   */
  @Test
  ...
  /**
   * Purpose: Reject update when address does not exist. Expected Result: NotFoundException is
   * thrown. Assertions: Error message matches NotFound and save is not called.
   */
  @Test
  ...
  /**
   * Purpose: Reject empty city. Expected Result: BadRequestException is thrown. Assertions: Error
   * message matches ER002.
   */
  @Test
  ...
  void updateAddress_EmptyCity_ThrowsBadRequestException() {
    ...
    BadRequestException exception =
        assertThrows(
            BadRequestException.class, () -> addressService.updateAddress(testAddressRequest));
  ...
  /**
   * Purpose: Reject invalid address type. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject invalid modified user on update. Expected Result: BadRequestException is
   * thrown. Assertions: Error message matches InvalidUser.
   */
  @Test
  ...
  /**
   * Purpose: Reject invalid postal code. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject update for max long ID. Expected Result: NotFoundException is thrown.
  ...
  /**
   * Purpose: Reject update for negative ID. Expected Result: NotFoundException is thrown.
   * Assertions: Error message matches NotFound and save is not called.
   */
  @Test
  ...
  /**
   * Purpose: Reject null city. Expected Result: BadRequestException is thrown. Assertions: Error
   * message matches ER002.
   */
  @Test
  ...
  /**
   * Purpose: Reject null update request. Expected Result: BadRequestException is thrown.
   * Assertions: Error message matches ER001.
   */
  @Test
  ...
  void updateAddress_NullRequest_ThrowsBadRequestException() {
    ...
    // Act & Assert
    BadRequestException exception =
        assertThrows(BadRequestException.class, () -> addressService.updateAddress(nullRequest));
  ...
  /**
   * Purpose: Reject update for zero ID. Expected Result: NotFoundException is thrown. Assertions:
   * Error message matches NotFound and save is not called.
   */
  @Test
   ...
   * UPDATE_ADDRESS_PERMISSION. Assertions: Annotation is present and contains expected permission
   * string.
   */
  @Test
  ...
  void updateAddress_p03_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    ResponseEntity<?> response =
        addressController.updateAddress(DEFAULT_ADDRESS_ID, testAddressRequest);

    // Assert
    assertNotNull(
        preAuthorizeAnnotation, "updateAddress method should have @PreAuthorize annotation");
