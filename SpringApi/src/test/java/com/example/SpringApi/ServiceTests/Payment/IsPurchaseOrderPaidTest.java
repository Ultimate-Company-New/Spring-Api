...
class IsPurchaseOrderPaidTest extends PaymentServiceTestBase {
    ...
    /**
     * Purpose: Verify successful payment presence returns true.
    ...
    /**
     * Purpose: Verify repository interaction parameters.
     * Expected Result: hasSuccessfulPayment called once with expected args.
     * Assertions: verify interaction.
     */
    @Test
    ...
    /**
     * Purpose: Verify no successful payment returns false.
    ...
    /**
     * Purpose: Verify negative purchase order id returns false.
     * Expected Result: false.
     * Assertions: assertFalse(result).
     */
    @Test
    ...
    /**
     * Purpose: Verify zero purchase order id returns false.
     * Expected Result: false.
     * Assertions: assertFalse(result).
     */
    @Test
    ...
    /**
     * Purpose: Verify additional ids return false when repository responds false.
     * Expected Result: false for each id.
     * Assertions: assertFalse for each id and repository invocation count.
     */
    @Test
    ...
    void isPurchaseOrderPaid_f04_additionalPurchaseOrderIds_failure() {
        ...
        verify(paymentRepository, times(ids.length)).hasSuccessfulPayment(eq("PURCHASE_ORDER"), anyLong());
    }
