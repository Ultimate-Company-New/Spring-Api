...
class GetPaymentsForPurchaseOrderTest extends PaymentServiceTestBase {
    ...
    /**
     * Purpose: Verify service returns payment history when purchase order exists and client has access.
     * Expected Result: Returned list matches repository result.
     * Assertions: List size, order, and repository interaction.
     */
    @Test
