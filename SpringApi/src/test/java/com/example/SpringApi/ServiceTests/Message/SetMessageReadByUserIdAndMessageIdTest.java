...
class SetMessageReadByUserIdAndMessageIdTest extends MessageServiceTestBase {
  ...
  /**
   * Purpose: Verify that the setMessageReadByUserIdAndMessageId controller method is protected by
  ...
  void setMessageReadByUserIdAndMessageId_VerifyPreAuthorizeAnnotation_Success()
      throws NoSuchMethodException {
    // Arrange
    Method method =
        MessageController.class.getMethod(
            "setMessageReadByUserIdAndMessageId", Long.class, Long.class);
    ...
    assertTrue(
        annotation.value().contains(Authorizations.VIEW_MESSAGES_PERMISSION),
