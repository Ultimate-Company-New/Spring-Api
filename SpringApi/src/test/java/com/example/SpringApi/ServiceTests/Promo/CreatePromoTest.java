...
class CreatePromoTest extends PromoServiceTestBase {
  ...
  void createPromo_DiscountValueZero_ThrowsBadRequestException() {
    ...
    BadRequestException ex =
        assertThrows(BadRequestException.class, () -> promoService.createPromo(testPromoRequest));
    assertEquals(
        ErrorMessages.PromoErrorMessages.DISCOUNT_VALUE_GREATER_THAN_ZERO, ex.getMessage());
  }
  ...
  void createPromo_NullRequest_ThrowsBadRequestException() {
    ...
    // Act & Assert
    BadRequestException ex =
        assertThrows(BadRequestException.class, () -> promoService.createPromo(request));
