...
class SecurityConfigTest {
    ...
    /**
     * Purpose: Verify CORS configuration source exposes expected origins, methods, and credential settings.
     * Expected Result: Registered configuration resolves for arbitrary path with configured values.
     * Assertions: Origins, methods, headers, credentials, and max-age.
     */
    @Test
