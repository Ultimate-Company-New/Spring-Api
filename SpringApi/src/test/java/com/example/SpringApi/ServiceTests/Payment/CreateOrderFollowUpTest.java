...
class CreateOrderFollowUpTest extends PaymentServiceTestBase {
  ...
  void createOrderFollowUp_p02_controllerPreAuthorizeAnnotation_success()
      throws NoSuchMethodException {
    // Arrange
    Method method =
        PaymentController.class.getMethod("createOrderFollowUp", RazorpayOrderRequestModel.class);
