...
class CreateOrderFollowUpTest extends PaymentServiceTestBase {
    ...
    /**
     * Purpose: Verify follow-up order creation computes pending amount from order summary and existing payments.
     * Expected Result: Successful response with pending amount and follow-up note metadata.
     * Assertions: Response values, saved payment, and Razorpay notes payload.
     */
    @Test
    ...
    void createOrderFollowUp_s02_pendingAmountFallbackAndNotes_success() throws Exception {
        ...
        try {
            ...
            assertTrue(savedPayment.getDescription().startsWith("Follow-up payment for Purchase Order #"));
            assertNotNull(capturedRazorpayOrderCreateRequest);
            assertEquals("true",
                    capturedRazorpayOrderCreateRequest.getJSONObject("notes").getString("is_follow_up_payment"));
        } finally {
     ...
     * Expected Result: BadRequestException with API key validation message.
     * Assertions: Exception type and exact message.
     */
    @Test
     ...
     * Expected Result: BadRequestException with API secret validation message.
     * Assertions: Exception type and exact message.
     */
    @Test
    ...
    void createOrderFollowUp_f12_razorpayOrderCreateException_failure() {
        ...
        try {
            ...
            assertEquals(String.format(
                    ...
                    "follow-up gateway unavailable"), ex.getMessage());
        } finally {
            closeMockedRazorpayClientConstruction();
        }
    }
