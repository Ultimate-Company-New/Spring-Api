...
class GetAvailableServicesTest extends QAServiceTestBase {
  ...
  void getAvailableServices_s02_success_allNamesEndWithService() {
    ...
    for (String service : services) {
      assertTrue(service.endsWith("Service"), "Service name should end with 'Service': " + service);
    }
  }
  ...
  void getAvailableServices_s06_list_containsNoDuplicates() {
    ...
    assertEquals(
        services.size(), uniqueServices.size(), "Services list should not contain duplicates");
  }
  ...
  void getAvailableServices_s08_multipleInvocations_returnsSameList() {
    ...
    assertTrue(
        services1.containsAll(services2), "Multiple invocations should return same services");
    assertTrue(
        services2.containsAll(services1), "Multiple invocations should return same services");
  }
  ...
  void getAvailableServices_s09_list_isImmutable() {
    ...
    try {
      ...
      assertEquals(originalSize, services.size(), "List should be immutable or defensively copied");
  ...
  void getAvailableServices_s10_count_matchesServiceMappings() {
    ...
    for (String service : services) {
      assertTrue(
          service.matches("[A-Z][a-zA-Z]*Service"),
  ...
  void getAvailableServices_serviceFailure_ThrowsException() {
    ...
    // Act
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> qaService.getAvailableServices());
