...
class ApprovedByPurchaseOrderTest extends PurchaseOrderServiceTestBase {
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for approvedByPurchaseOrder. Expected Result:
  ...
  void approvedByPurchaseOrder_VerifyPreAuthorizeAnnotation_Success() throws NoSuchMethodException {
    ...
    // Assert
    assertNotNull(
        annotation, "@PreAuthorize annotation should be present on approvedByPurchaseOrder");
    assertTrue(
