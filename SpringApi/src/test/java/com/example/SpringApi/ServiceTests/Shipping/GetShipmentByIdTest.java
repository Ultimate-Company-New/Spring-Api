...
class GetShipmentByIdTest extends ShippingServiceTestBase {
    ...
    /**
     * Purpose: Verify nested shipment graph is initialized for response mapping.
     * Expected Result: ShipmentResponseModel returned with nested lists.
     * Assertions: Response contains package and return shipment data.
     */
    @Test
