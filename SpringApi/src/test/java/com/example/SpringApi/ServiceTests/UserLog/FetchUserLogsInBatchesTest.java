...
class FetchUserLogsInBatchesTest extends UserLogServiceTestBase {
  ...
  /**
   * Purpose: Verify different carrier IDs are accepted. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  void fetchUserLogsInBatches_differentCarrierIds_success() {
    ...
    for (long carrierId : carrierIds) {
      ...
      assertDoesNotThrow(
          () -> userLogService.fetchUserLogsInBatches(carrierIdRequest),
          "Carrier ID " + carrierId + " should be accepted");
    }
  }

  /**
   * Purpose: Verify different user IDs are accepted. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  void fetchUserLogsInBatches_differentUserIds_success() {
    ...
    for (long userId : userIds) {
      ...
      assertDoesNotThrow(
          () -> userLogService.fetchUserLogsInBatches(userIdRequest),
          "User ID " + userId + " should be accepted");
    }
  }

  /**
   * Purpose: Verify behavior with empty result set. Expected Result: Empty list returned.
  ...
  void fetchUserLogsInBatches_emptyResultSet_success() {
    ...
    // Act
    PaginationBaseResponseModel<UserLogsResponseModel> emptyResult =
        userLogService.fetchUserLogsInBatches(emptyResultRequest);
  ...
  /** Purpose: Verify large page size. Expected Result: Success. Assertions: assertDoesNotThrow */
  @Test
  ...
  /**
   * Purpose: Verify multiple filters with AND logic. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  /**
   * Purpose: Verify multiple filters with OR logic. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  /**
   * Purpose: Verify multiple results returned. Expected Result: Correct size and count. Assertions:
   * assertEquals
   */
  @Test
  ...
  void fetchUserLogsInBatches_multipleResults_success() {
    // Arrange
    UserLog secondLog =
        new UserLog(TEST_USER_ID, TEST_CARRIER_ID, "User Logout", null, "logout", "admin");
    ...
    // Act
    PaginationBaseResponseModel<UserLogsResponseModel> multiResult =
        userLogService.fetchUserLogsInBatches(multiResultRequest);
  ...
  /**
   * Purpose: Verify no filters (basic pagination). Expected Result: Success. Assertions:
   * assertEquals
   */
  @Test
  ...
  void fetchUserLogsInBatches_noFilters_success() {
    ...
    // Act
    PaginationBaseResponseModel<UserLogsResponseModel> result =
        userLogService.fetchUserLogsInBatches(noFilterRequest);
  ...
  /**
   * Purpose: Verify valid logic operators. Expected Result: Success. Assertions: assertDoesNotThrow
   */
  @Test
  ...
  /**
   * Purpose: Verify valid number columns and operators. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  /**
   * Purpose: Verify valid string columns and operators. Expected Result: Success. Assertions:
   * assertDoesNotThrow
   */
  @Test
  ...
  /**
   * Purpose: Verify invalid column names throw BadRequestException. Expected Result:
   * BadRequestException thrown. Assertions: assertThrows, assertTrue
   */
  @Test
  ...
  void fetchUserLogsInBatches_invalidColumnNames_badRequestException() {
    ...
    for (String invalidColumn : invalidColumns) {
      ...
      assertTrue(
          ex.getMessage().contains(invalidColumn),
          "Error message should indicate invalid column name");
    }
  }

  /**
   * Purpose: Verify invalid logic operators throw BadRequestException. Expected Result:
   * BadRequestException thrown. Assertions: assertThrows, assertEquals
   */
  @Test
  ...
  /**
   * Purpose: Verify invalid pagination parameters. Expected Result: BadRequestException thrown.
  ...
  void fetchUserLogsInBatches_controller_permission_forbidden() throws NoSuchMethodException {
    ...
    Method method =
        UserLogController.class.getMethod("fetchUserLogsInBatches", UserLogsRequestModel.class);
