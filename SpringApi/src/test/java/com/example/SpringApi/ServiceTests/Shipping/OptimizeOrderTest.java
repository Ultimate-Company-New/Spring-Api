...
/**
    ...
    /**
     * Purpose: Verify custom allocation with unknown product returns validation error.
     * Expected Result: Response success is false.
     * Assertions: Error contains unknown product id.
     */
    @Test
    ...
    /**
     * Purpose: Verify custom allocation with unknown location returns validation error.
     * Expected Result: Response success is false.
     * Assertions: Error contains unknown location id.
     */
    @Test
    ...
    /**
     * Purpose: Verify custom allocation with insufficient stock returns validation error.
     * Expected Result: Response success is false.
     * Assertions: Error contains insufficient stock details.
     */
    @Test
    @DisplayName("optimizeOrder - Custom Insufficient Stock - Error")
    void optimizeOrder_CustomInsufficientStock_Error() {
        // Arrange
        optimizationRequest.setCustomAllocations(Map.of(TEST_PRODUCT_ID, Map.of(TEST_PICKUP_LOCATION_ID, 11)));
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 10);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
        stubPackagePickupLocationMappingRepositoryFindByPickupLocationIdsWithPackages(
    ...
    /**
     * Purpose: Verify custom allocation with only zero quantities returns validation error.
     * Expected Result: Response success is false.
     * Assertions: Error equals NoValidAllocationsSpecified.
     */
    @Test
    @DisplayName("optimizeOrder - Custom No Valid Quantities - Error")
    void optimizeOrder_CustomNoValidQuantities_Error() {
        // Arrange
        optimizationRequest.setCustomAllocations(Map.of(TEST_PRODUCT_ID, Map.of(TEST_PICKUP_LOCATION_ID, 0)));
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 10);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
        stubPackagePickupLocationMappingRepositoryFindByPickupLocationIdsWithPackages(List.of());
        ...
        // Assert
        assertFalse(result.getSuccess());
        assertEquals(ErrorMessages.OrderOptimizationErrorMessages.NO_VALID_ALLOCATIONS_SPECIFIED, result.getErrorMessage());
    }

    /**
     * Purpose: Verify route with no couriers marks response as unavailable.
     * Expected Result: Response success is true with courier unavailability metadata.
     * Assertions: allCouriersAvailable false and error message populated.
     */
    @Test
    ...
    void optimizeOrder_NoCourierOptions_UnavailableStrategy() {
        ...
        assertEquals(ErrorMessages.OrderOptimizationErrorMessages.NO_SHIPPING_OPTIONS_FOR_ANY_STRATEGY,
                result.getErrorMessage());
        assertNotNull(result.getUnavailabilityReason());
    }

    /**
     * Purpose: Verify heavy shipments are split when route max weight is limited.
     * Expected Result: Optimization succeeds with multiple shipments.
     * Assertions: shipment count is greater than one.
     */
    @Test
    ...
    void optimizeOrder_SplitShipmentsByRouteMaxWeight_Success() {
        ...
        stubClientServiceGetClientById(testClientResponse);
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 3);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
        com.example.SpringApi.Models.DatabaseModels.Package heavyPackage = new com.example.SpringApi.Models.DatabaseModels.Package();
        ...
        PackagingHelper.MultiProductPackagingResult multiProductPackagingResult = new PackagingHelper.MultiProductPackagingResult(
        ...
        stubShipRocketHelperGetAvailableShippingOptionsByRouteAndWeight(
                optionsByRouteAndWeight,
                createShippingOptions(20.0));
    ...
    /**
     * Purpose: Verify product exceeding package limits returns explicit error.
     * Expected Result: Response success is false.
     * Assertions: Error message matches ProductExceedsPackageLimitsFormat.
     */
    @Test
    ...
    void optimizeOrder_ProductExceedsPackageLimits_Error() {
        ...
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 5);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
        stubPackagePickupLocationMappingRepositoryFindByPickupLocationIdsWithPackages(
        ...
        // Assert
        assertFalse(result.getSuccess());
        assertEquals(String.format(ErrorMessages.OrderOptimizationErrorMessages.PRODUCT_EXCEEDS_PACKAGE_LIMITS_FORMAT,
                testProduct.getTitle(), 5, 2), result.getErrorMessage());
    }

    /**
     * Purpose: Verify no available package quantities returns explicit error.
     * Expected Result: Response success is false.
     * Assertions: Error message matches NoPackagesAvailableFormat.
     */
    @Test
    ...
    void optimizeOrder_NoAvailablePackageQuantities_Error() {
        ...
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 1);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
        stubPackagePickupLocationMappingRepositoryFindByPickupLocationIdsWithPackages(
        ...
        // Assert
        assertFalse(result.getSuccess());
        assertEquals(String.format(ErrorMessages.OrderOptimizationErrorMessages.NO_PACKAGES_AVAILABLE_FORMAT,
                testProduct.getTitle(), 1, 2), result.getErrorMessage());
    }

    /**
     * Purpose: Verify token retrieval failure does not break optimization flow.
     * Expected Result: Response success remains true.
     * Assertions: success flag true.
     */
    @Test
    ...
    /**
     * Purpose: Verify custom allocation retains unserviceable-route reason when no courier exists for route.
     * Expected Result: Response success true with allCouriersAvailable false.
     * Assertions: Unavailability reason and error message are populated.
     */
    @Test
    @DisplayName("optimizeOrder - Custom Unserviceable Route - Unavailable")
    void optimizeOrder_CustomUnserviceableRoute_Unavailable() {
        // Arrange
        optimizationRequest.setCustomAllocations(Map.of(TEST_PRODUCT_ID, Map.of(TEST_PICKUP_LOCATION_ID, 1)));
        stubClientServiceGetClientById(testClientResponse);
        stubProductRepositoryFindAllById(List.of(testProduct));
        ProductPickupLocationMapping mapping = createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 10);
        stubProductPickupLocationMappingRepositoryFindByProductIdWithPickupLocationAndAddress(List.of(mapping));
     ...
     * Expected Result: Response success true with no-courier availability.
     * Assertions: Unavailability reason includes package-fit warning.
     */
    @Test
    ...
    void optimizeOrder_NoPackageUsage_Unavailable() {
        ...
        stubPackagePickupLocationMappingRepositoryFindByPickupLocationIdsWithPackages(
                List.of(createPackagePickupLocationMapping(TEST_PACKAGE_ID, TEST_PICKUP_LOCATION_ID, 10)));
        stubPackagingHelperCalculatePackaging(createPackagingEstimateResult(2, 2));
        PackagingHelper.MultiProductPackagingResult emptyPackages = new PackagingHelper.MultiProductPackagingResult(
     ...
     * Expected Result: Response success true with courier unavailability metadata.
     * Assertions: Unavailability reason mentions missing postal code.
     */
    @Test
    ...
    /**
     * Purpose: Verify route probing handles provider exceptions and continues optimization.
     * Expected Result: Response success true with unavailability metadata.
     * Assertions: Response remains non-null and marked unavailable.
     */
    @Test
