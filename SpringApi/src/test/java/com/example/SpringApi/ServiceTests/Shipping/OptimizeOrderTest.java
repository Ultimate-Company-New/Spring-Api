...
class OptimizeOrderTest extends ShippingServiceTestBase {
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for optimizeOrder. Expected Result: Annotation
  ...
  void optimizeOrder_VerifyPreAuthorizeAnnotation_Success() throws NoSuchMethodException {
    // Arrange
    Method method =
        ShippingController.class.getMethod("optimizeOrder", OrderOptimizationRequestModel.class);
