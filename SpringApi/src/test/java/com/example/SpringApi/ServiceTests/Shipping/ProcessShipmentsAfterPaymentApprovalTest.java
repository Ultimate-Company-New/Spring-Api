...
class ProcessShipmentsAfterPaymentApprovalTest extends ShippingServiceTestBase {
   ...
   */
  /**
   * Purpose: Verify user log is recorded on success. Expected Result: User log service is called.
  ...
  void processShipmentsAfterPaymentApproval_LogsUserAction_Success() {
    ...
    ProductPickupLocationMapping productMapping =
    ...
    PackagePickupLocationMapping packageMapping =
        createPackagePickupLocationMapping(TEST_PACKAGE_ID, TEST_PICKUP_LOCATION_ID, 10);
    stubPackagePickupLocationMappingRepositoryFindByPackageIdAndPickupLocationId(packageMapping);
    stubPaymentServiceVerifyPayment(
        PaymentVerificationResponseModel.success(
            "pay", TEST_PURCHASE_ORDER_ID, PurchaseOrder.Status.APPROVED.getValue()));
  ...
  /**
   * Purpose: Verify shipment save is invoked on online payment success. Expected Result: Shipment
   * repository save is called. Assertions: Verify save called.
   */
  @Test
  ...
  /**
   * Purpose: Verify successful online payment processing. Expected Result:
   * PaymentVerificationResponseModel indicates success. Assertions: Response success is true.
   */
  @Test
  ...
  void processShipmentsAfterPaymentApproval_ValidRequest_Success() {
    ...
    // Act
    PaymentVerificationResponseModel result =
   ...
   */
  /**
   * Purpose: Verify client mismatch throws BadRequestException. Expected Result:
   * BadRequestException with AccessDenied message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Client Mismatch - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify credentials missing throws BadRequestException. Expected Result:
   * BadRequestException with ShipRocketCredentialsNotConfigured message. Assertions: Exception type
   * and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Credentials Missing - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify delivery address missing throws BadRequestException. Expected Result:
   * BadRequestException with DeliveryAddressNotFound message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Delivery Address Missing - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify order summary not found throws NotFoundException. Expected Result:
   * NotFoundException with OrderSummary not found message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Order Summary Not Found - Throws NotFoundException")
  ...
  /**
   * Purpose: Verify package not available throws BadRequestException. Expected Result:
   * BadRequestException with PackageNotAvailableAtPickupLocationFormat message. Assertions:
   * Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Package Not Available - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_PackageNotAvailable_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShipmentProcessingErrorMessages
                .PACKAGE_NOT_AVAILABLE_AT_PICKUP_LOCATION_FORMAT,
            TEST_PACKAGE_ID,
  ...
  /**
   * Purpose: Verify package stock insufficient throws BadRequestException. Expected Result:
   * BadRequestException with InsufficientPackageStockFormat message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Package Stock Insufficient - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_PackageStockInsufficient_ThrowsBadRequestException() {
    ...
    stubProductPickupLocationMappingRepositoryFindByProductIdAndPickupLocationId(productMapping);
    PackagePickupLocationMapping packageMapping =
        createPackagePickupLocationMapping(TEST_PACKAGE_ID, TEST_PICKUP_LOCATION_ID, 0);
    stubPackagePickupLocationMappingRepositoryFindByPackageIdAndPickupLocationId(packageMapping);
    ...
    assertEquals(
        String.format(
            ...
            TEST_PICKUP_LOCATION_ID,
            0,
            testShipmentPackage.getQuantityUsed()),
        ex.getMessage());
  }

  /**
   * Purpose: Verify payment failure throws BadRequestException. Expected Result:
   * BadRequestException with OperationFailedWithMessageFormat message. Assertions: Exception type
   * and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Payment Failure - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_PaymentFailure_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShipmentProcessingErrorMessages.OPERATION_FAILED_WITH_MESSAGE_FORMAT,
  ...
  /**
   * Purpose: Verify pickup location not found throws NotFoundException. Expected Result:
   * NotFoundException with PickupLocation not found message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Pickup Location Not Found - Throws NotFoundException")
  ...
  /**
   * Purpose: Verify purchase order not found throws NotFoundException. Expected Result:
   * NotFoundException with InvalidId message. Assertions: Exception type and message.
   */
  @Test
  ...
  /**
   * Purpose: Verify product not available throws BadRequestException. Expected Result:
   * BadRequestException with ProductNotAvailableAtPickupLocationFormat message. Assertions:
   * Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Product Not Available - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_ProductNotAvailable_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShipmentProcessingErrorMessages
                .PRODUCT_NOT_AVAILABLE_AT_PICKUP_LOCATION_FORMAT,
            TEST_PRODUCT_ID,
            TEST_PICKUP_LOCATION_ID),
        ex.getMessage());
  }
  ...
  /**
   * Purpose: Verify empty shipments list throws BadRequestException. Expected Result:
   * BadRequestException with NoShipmentsFound message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Shipments Empty - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify invalid status throws BadRequestException. Expected Result: BadRequestException
   * with ShipRocketOrderCreationFailed message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Invalid Status - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_ShipRocketInvalidStatus_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.SHIP_ROCKET_ORDER_CREATION_FAILED,
            TEST_SHIPMENT_ID,
            expectedDetail),
        ex.getMessage());
  }
  ...
  /**
   * Purpose: Verify missing order_id throws BadRequestException. Expected Result:
   * BadRequestException with ShipRocketOrderCreationFailed message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Missing Order Id - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify missing shipment_id throws BadRequestException. Expected Result:
   * BadRequestException with ShipRocketOrderCreationFailed message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Missing Shipment Id - Throws BadRequestException")
  void
      processShipmentsAfterPaymentApproval_ShipRocketMissingShipmentId_ThrowsBadRequestException() {
    // Arrange
    stubPurchaseOrderRepositoryFindById(testPurchaseOrder);
    stubOrderSummaryRepositoryFindByEntityTypeAndEntityId(testOrderSummary);
    stubShipmentRepositoryFindByOrderSummaryId(List.of(testShipment));
  ...
  /**
   * Purpose: Verify missing status throws BadRequestException. Expected Result: BadRequestException
   * with ShipRocketOrderCreationFailed message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Missing Status - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify ShipRocket response message throws BadRequestException. Expected Result:
   * BadRequestException with ShipRocketOrderCreationFailed message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Response Message - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify null ShipRocket response throws BadRequestException. Expected Result:
   * BadRequestException with ShipRocketApiNullResponse message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - ShipRocket Response Null - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_ShipRocketResponseNull_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.SHIP_ROCKET_API_NULL_RESPONSE, TEST_SHIPMENT_ID),
        ex.getMessage());
  }

  /**
   * Purpose: Verify status not pending throws BadRequestException. Expected Result:
   * BadRequestException with OnlyPendingApprovalCanBePaid message. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Status Not Pending - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify successful cash payment shipment processing. Expected Result:
   * PaymentVerificationResponseModel indicates success. Assertions: Response success is true.
   */
  @Test
  ...
  void processShipmentsAfterPaymentApproval_CashValidRequest_Success() {
    ...
    PackagePickupLocationMapping packageMapping =
        createPackagePickupLocationMapping(TEST_PACKAGE_ID, TEST_PICKUP_LOCATION_ID, 10);
    stubPackagePickupLocationMappingRepositoryFindByPackageIdAndPickupLocationId(packageMapping);
    stubPaymentServiceRecordCashPayment(
        PaymentVerificationResponseModel.success(
            "cash", TEST_PURCHASE_ORDER_ID, PurchaseOrder.Status.APPROVED.getValue()));
    stubClientRepositoryFindById(testClient);
    stubPickupLocationRepositoryFindById(testPickupLocation);
    stubShipmentRepositorySave(testShipment);
    stubShipRocketHelperCreateCustomOrder(createValidShipRocketOrderResponse());
  ...
  /**
   * Purpose: Verify order payload includes pricing/tax/receipt fields when configured. Expected
   * Result: Shipment processing succeeds. Assertions: Response success is true.
   */
  @Test
  ...
  /**
   * Purpose: Verify cash payment failure throws BadRequestException. Expected Result:
   * BadRequestException with OperationFailedWithMessageFormat. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash Payment Failure - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify missing pickup location nickname throws BadRequestException. Expected Result:
   * BadRequestException with PickupLocationNameNotConfigured. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Pickup Name Missing - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_PickupNameMissing_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.PICKUP_LOCATION_NAME_NOT_CONFIGURED,
            TEST_PICKUP_LOCATION_ID),
        ex.getMessage());
  }

  /**
   * Purpose: Verify invalid billing postal code throws BadRequestException. Expected Result:
   * BadRequestException with BillingPostalCodeMustBeNumeric. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Invalid Billing Postal - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_InvalidBillingPostal_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.BILLING_POSTAL_CODE_MUST_BE_NUMERIC, "40A001"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify invalid billing phone throws BadRequestException. Expected Result:
   * BadRequestException with BillingPhoneMustBe10Digits. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Invalid Billing Phone - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_InvalidBillingPhone_ThrowsBadRequestException() {
    ...
    // Assert
    assertEquals(
        String.format(ErrorMessages.ShippingErrorMessages.BILLING_PHONE_MUST_BE10_DIGITS, "12345"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify AWB assignment exception throws BadRequestException. Expected Result:
   * BadRequestException with AwbAssignmentFailed. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - AWB Assign Exception - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_AwbAssignException_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.AWB_ASSIGNMENT_FAILED,
            shipRocketResponse.getShipmentId(),
            "awb-error"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify order-details fallback serialization path still succeeds. Expected Result:
   * Shipment is saved with fallback full response and AWB from response. Assertions: Saved shipment
   * contains full response and awb code.
   */
  @Test
  ...
  /**
   * Purpose: Verify cash flow throws when purchase order is not found. Expected Result:
   * NotFoundException with InvalidId message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash PO Not Found - Throws NotFoundException")
  ...
  /**
   * Purpose: Verify cash flow rejects purchase orders belonging to another client. Expected Result:
   * BadRequestException with AccessDeniedToPurchaseOrder. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash Client Mismatch - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify cash flow rejects non-pending purchase order status. Expected Result:
   * BadRequestException with OnlyPendingApprovalCanBePaid. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash Status Not Pending - Throws BadRequestException")
  ...
  /**
   * Purpose: Verify cash flow throws when order summary is missing. Expected Result:
   * NotFoundException with OrderSummary not found message. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash Order Summary Not Found - Throws NotFoundException")
  ...
  /**
   * Purpose: Verify cash flow throws when no shipments exist for order summary. Expected Result:
   * BadRequestException with NoShipmentsFound. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Cash Shipments Empty - Throws BadRequestException")
   ...
   * Expected Result: BadRequestException with InsufficientProductStockFormat. Assertions: Exception
   * type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Product Stock Insufficient - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_ProductStockInsufficient_ThrowsBadRequestException() {
    ...
    stubShipmentPackageRepositoryFindByShipmentId(List.of(testShipmentPackage));
    ProductPickupLocationMapping productMapping =
        createProductPickupLocationMapping(TEST_PRODUCT_ID, TEST_PICKUP_LOCATION_ID, 0);
    stubProductPickupLocationMappingRepositoryFindByProductIdAndPickupLocationId(productMapping);
    ...
    assertEquals(
        String.format(
            ...
            TEST_PICKUP_LOCATION_ID,
            0,
            testShipmentProduct.getAllocatedQuantity()),
        ex.getMessage());
  }

  /**
   * Purpose: Verify client lookup failure during ShipRocket processing throws NotFoundException.
   * Expected Result: NotFoundException with Client invalid id message. Assertions: Exception type
   * and message.
   */
  @Test
  ...
  /**
   * Purpose: Verify package lookup failure while building ShipRocket request throws
   * NotFoundException. Expected Result: NotFoundException with package id message. Assertions:
   * Exception type and message.
   */
  @Test
  ...
  void processShipmentsAfterPaymentApproval_PackageMissing_ThrowsNotFoundException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.PackageErrorMessages.INVALID_ID_WITH_ID_FORMAT, TEST_PACKAGE_ID),
        ex.getMessage());
  }

  /**
   * Purpose: Verify order request uses default dimensions when shipment has no package entries.
   * Expected Result: Shipment processing succeeds with default LxBxH dimensions. Assertions:
   * Captured request dimensions are 10.0 each.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - No Packages Uses Default Dimensions - Success")
  void processShipmentsAfterPaymentApproval_NoPackagesUsesDefaultDimensions_Success() {
    ...
    // Assert
    ArgumentCaptor<ShipRocketOrderRequestModel> requestCaptor =
        ArgumentCaptor.forClass(ShipRocketOrderRequestModel.class);
  ...
  /**
   * Purpose: Verify null billing phone produces explicit validation error. Expected Result:
   * BadRequestException with BillingPhoneMustBe10Digits using "empty". Assertions: Exception type
   * and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Billing Phone Null - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_BillingPhoneNull_ThrowsBadRequestException() {
    ...
    // Assert
    assertEquals(
        String.format(ErrorMessages.ShippingErrorMessages.BILLING_PHONE_MUST_BE10_DIGITS, "empty"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify phone numbers longer than 10 digits are normalized to the last 10. Expected
   * Result: Shipment processing succeeds and billing phone is normalized. Assertions: Captured
   * request billing phone equals normalized value.
   */
  @Test
  ...
  /**
   * Purpose: Verify pickup-generation API failure is converted to domain exception. Expected
   * Result: BadRequestException with PickupGenerationFailed. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Pickup Generation Error - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_PickupGenerationError_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.PICKUP_GENERATION_FAILED, 2001L, "pickup-error"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify manifest-generation API failure is converted to domain exception. Expected
   * Result: BadRequestException with ManifestGenerationFailed. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Manifest Generation Error - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_ManifestGenerationError_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.MANIFEST_GENERATION_FAILED,
            2001L,
            "manifest-error"),
        ex.getMessage());
  }
  ...
  /**
   * Purpose: Verify label-generation API failure is converted to domain exception. Expected Result:
   * BadRequestException with LabelGenerationFailed. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Label Generation Error - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_LabelGenerationError_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.LABEL_GENERATION_FAILED, 2001L, "label-error"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify invoice-generation API failure is converted to domain exception. Expected
   * Result: BadRequestException with InvoiceGenerationFailed. Assertions: Exception type and
   * message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Invoice Generation Error - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_InvoiceGenerationError_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.INVOICE_GENERATION_FAILED, 2001L, "invoice-error"),
        ex.getMessage());
  }

  /**
   * Purpose: Verify tracking API failure is converted to domain exception. Expected Result:
   * BadRequestException with TrackingFetchFailed. Assertions: Exception type and message.
   */
  @Test
  @DisplayName(
      "processShipmentsAfterPaymentApproval - Tracking Fetch Error - Throws BadRequestException")
  void processShipmentsAfterPaymentApproval_TrackingFetchError_ThrowsBadRequestException() {
    ...
    assertEquals(
        String.format(
            ErrorMessages.ShippingErrorMessages.TRACKING_FETCH_FAILED, "AWB-1", "tracking-error"),
        ex.getMessage());
  }
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for processPaymentAndShipments. Expected Result:
  ...
  void processShipmentsAfterPaymentApproval_VerifyPreAuthorizeAnnotation_Success()
      throws NoSuchMethodException {
    // Arrange
    Method method =
        com.example.SpringApi.Controllers.PaymentController.class.getMethod(
            "processPaymentAndShipments",
            com.example.SpringApi.Models.RequestModels.ProcessPaymentAndShipmentRequestModel.class);
    ...
    assertTrue(
        annotation
            .value()
            .contains(
                com.example.SpringApi.Models.Authorizations.UPDATE_PURCHASE_ORDERS_PERMISSION));
  }
}
