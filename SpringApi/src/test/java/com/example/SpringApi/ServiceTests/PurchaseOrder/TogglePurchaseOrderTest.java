...
class TogglePurchaseOrderTest extends PurchaseOrderServiceTestBase {
  ...
  /**
   * Purpose: Verify toggle marks as deleted. Expected Result: isDeleted becomes true. Assertions:
   * Save is called and flag toggled.
   */
  @Test
  ...
  /**
   * Purpose: Verify toggle restores deleted purchase order. Expected Result: isDeleted becomes
   * false. Assertions: Save is called and flag toggled.
   */
  @Test
  ...
  /**
   * Purpose: Reject toggle for missing purchase order. Expected Result: NotFoundException is
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for togglePurchaseOrder. Expected Result:
   * Annotation exists and includes TOGGLE_PURCHASE_ORDERS_PERMISSION. Assertions: Annotation is
  ...
  void togglePurchaseOrder_VerifyPreAuthorizeAnnotation_Success() throws NoSuchMethodException {
    ...
    assertTrue(
        annotation.value().contains(Authorizations.TOGGLE_PURCHASE_ORDERS_PERMISSION),
