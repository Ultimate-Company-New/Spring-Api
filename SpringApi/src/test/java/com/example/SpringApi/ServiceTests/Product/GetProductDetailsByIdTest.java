...
/**
 * Consolidated test class for ProductService.getProductDetailsById. Fully compliant with Unit Test
 * Verification rules.
 */
...
class GetProductDetailsByIdTest extends ProductServiceTestBase {
  ...
  /**
   * Purpose: Verify success when product is found. Expected Result: Product response is returned.
  ...
  /**
   * Purpose: Verify failure when product is not found. Expected Result: NotFoundException is
   ...
   * permission. Assertions: Annotation is present and contains VIEW_PRODUCTS_PERMISSION.
   */
  @Test
  @DisplayName("getProductDetailsById - Verify @PreAuthorize annotation - Success")
  void getProductDetailsById_p02_VerifyPreAuthorizeAnnotation_Success()
