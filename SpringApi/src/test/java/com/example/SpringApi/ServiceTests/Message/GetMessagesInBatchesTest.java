...
class GetMessagesInBatchesTest extends MessageServiceTestBase {
  ...
  /**
   * Purpose: Verify that the getMessagesInBatches controller method is protected by
  ...
  void getMessagesInBatches_VerifyPreAuthorizeAnnotation_Success() throws NoSuchMethodException {
    // Arrange
    Method method =
        MessageController.class.getMethod("getMessagesInBatches", PaginationBaseRequestModel.class);
    ...
    // Assert
    assertNotNull(
        preAuthorizeAnnotation, "getMessagesInBatches method should have @PreAuthorize annotation");
