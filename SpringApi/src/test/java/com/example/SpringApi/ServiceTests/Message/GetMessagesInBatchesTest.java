...
class GetMessagesInBatchesTest extends MessageServiceTestBase {
    ...
    /**
     * Purpose: Verify successful retrieval of messages in batches without filters.
     * Scenario: Call getMessagesInBatches with valid pagination range.
     * Expected: Paginated response containing list of messages and total count.
     */
    @Test
    ...
    /**
     * Purpose: Verify that batch retrieval works correctly with all supported
     * column filters.
     * Scenario: Call getMessagesInBatches for each valid filter column.
     * Expected: No exceptions thrown and repository called for each valid column.
     */
    @Test
    ...
    /**
     * Purpose: Reject batch retrieval request when filter column names are not
     * recognized.
    ...
    /**
     * Purpose: Reject batch retrieval request when end index is less than or equal
     * to start index.
