...
class GetProductReviewsInBatchesGivenProductIdTest extends ProductReviewServiceTestBase {
  ...
  void getProductReviewsInBatchesGivenProductId_verifyPreAuthorizeAnnotation_success()
      throws NoSuchMethodException {
    // Arrange
    Method method =
        ProductReviewController.class.getMethod(
            "getProductReviewsGivenProductId",
    ...
    // Assert
    assertNotNull(
        annotation, "getProductReviewsGivenProductId should have @PreAuthorize annotation");
  }
}
