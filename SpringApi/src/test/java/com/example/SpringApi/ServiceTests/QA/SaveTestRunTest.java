...
class SaveTestRunTest extends QAServiceTestBase {
    ...
    /**
     * Purpose: Verify existing latest-test records are updated (not inserted as new).
     * Expected Result: Existing latest result is loaded and saved after update.
     * Assertions: Save succeeds and repository save is called for existing entity.
     */
    @Test
    void saveTestRun_s07_existingLatestResult_updatesExistingRecord() {
        ...
        LatestTestResult existingLatest = createLatestTestResult(77L, "QAService",
                "saveTestRun_s01_ValidRequest_Success");
