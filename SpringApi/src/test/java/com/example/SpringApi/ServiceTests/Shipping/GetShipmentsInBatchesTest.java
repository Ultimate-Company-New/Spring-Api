...
class GetShipmentsInBatchesTest extends ShippingServiceTestBase {
    ...
    /**
     * Purpose: Verify pageable offset is propagated from start index.
     * Expected Result: Query builder receives expected offset.
     * Assertions: Response is returned without error.
     */
    @Test
