...
class GetShipmentsInBatchesTest extends ShippingServiceTestBase {
  ...
  /**
   * Purpose: Verify controller has @PreAuthorize for getShipmentsInBatches. Expected Result:
   * Annotation exists and includes VIEW_SHIPMENTS_PERMISSION. Assertions: Annotation is present and
   * contains permission.
   */
  @Test
  ...
  void getShipmentsInBatches_VerifyPreAuthorizeAnnotation_Success() throws NoSuchMethodException {
    ...
    Method method =
        ShippingController.class.getMethod(
            "getShipmentsInBatches", PaginationBaseRequestModel.class);
