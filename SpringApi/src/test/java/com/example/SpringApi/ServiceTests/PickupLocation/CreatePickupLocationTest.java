 ...
 * fields, edge cases, and error handling. Test Count: 40 tests
 */
...
class CreatePickupLocationTest extends PickupLocationServiceTestBase {
  ...
  /**
   * Purpose: Verify address nickname at minimum length (1 char) succeeds. Expected Result: Creation
   * successful. Assertions: assertDoesNotThrow verifies success.
   */
  @Test
  ...
  /**
   * Purpose: Verify basic success scenario where location is saved. Expected Result: Pickup
   * location and address are saved. Assertions: Repositories are called the expected number of
   * times.
   */
  @Test
  ...
  /**
   * Purpose: Verify address with alphanumeric postal code. Expected Result: Creation succeeds with
   * alphanumeric postal code. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Verify international characters in address. Expected Result: Creation succeeds with
   * UTF-8 characters. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Verify isDeleted flag is correctly set to false on creation. Expected Result: New
   * location is marked as active (not deleted). Assertions: Location is not marked as deleted.
   */
  @Test
  ...
  /**
   * Purpose: Verify address with max phone length. Expected Result: Creation succeeds with long
   * phone number. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Reject null address object. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject address with null city. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject address with null country. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject null address nickname. Expected Result: BadRequestException is thrown.
  ...
  void createPickupLocation_NullNickname_ThrowsBadRequestException() {
    ...
    // Assert
    assertEquals(
        ErrorMessages.PickupLocationErrorMessages.INVALID_ADDRESS_NICK_NAME, ex.getMessage());
  }

  /**
   * Purpose: Verify null phone is accepted as optional field. Expected Result: Creation succeeds.
  ...
  /**
   * Purpose: Reject null request object. Expected Result: BadRequestException is thrown.
  ...
  void createPickupLocation_NullRequest_ThrowsBadRequestException() {
    ...
    BadRequestException ex =
        assertThrows(
            BadRequestException.class, () -> pickupLocationService.createPickupLocation(null));
  ...
  /**
   * Purpose: Reject null state. Expected Result: BadRequestException is thrown. Assertions: Message
   * contains ER003.
   */
  @Test
  ...
  /**
   * Purpose: Reject null street address. Expected Result: BadRequestException is thrown.
   * Assertions: Message contains ER001.
   */
  @Test
  ...
  /**
   * Purpose: Verify address with numeric postal code (all digits). Expected Result: Creation
   * succeeds with numeric postal code. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Verify repository exception handling during address save. Expected Result: Exception
   * is propagated. Assertions: Exception is thrown.
   */
  @Test
  ...
  void createPickupLocation_RepositoryErrorOnAddressSave_ThrowsException() {
    // Arrange
    stubAddressRepositorySaveThrows(
  ...
  /**
   * Purpose: Verify repository exception handling during pickup location save. Expected Result:
   * Exception is propagated. Assertions: Exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Verify special characters in street address. Expected Result: Creation succeeds.
   * Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Verify long nickname at max length is accepted. Expected Result: Creation succeeds
   * with long nickname. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Reject whitespace city. Expected Result: BadRequestException is thrown. Assertions:
   * Message contains ER002.
   */
  @Test
  ...
  /**
   * Purpose: Reject whitespace country. Expected Result: BadRequestException is thrown. Assertions:
   * Message contains ER005.
   */
  @Test
  ...
  /**
   * Purpose: Reject whitespace nickname. Expected Result: BadRequestException is thrown.
   * Assertions: Message contains InvalidAddressNickName.
   */
  @Test
  ...
  /**
   * Purpose: Verify whitespace phone is accepted as optional field. Expected Result: Creation
   * succeeds. Assertions: No exception is thrown.
   */
  @Test
  ...
  /**
   * Purpose: Reject whitespace postal code. Expected Result: BadRequestException is thrown.
  ...
  /**
   * Purpose: Reject whitespace state. Expected Result: BadRequestException is thrown. Assertions:
   * Message contains ER003.
   */
  @Test
  ...
  /**
   * Purpose: Reject whitespace street address. Expected Result: BadRequestException is thrown.
   * Assertions: Message contains ER001.
   */
  @Test
  ...
  /**
   * Purpose: Verify valid product/package mappings are persisted and invalid entries are skipped.
   * Expected Result: Mapping repositories save only valid rows. Assertions: Each mapping repository
   * save is called once.
   */
  @Test
  @DisplayName("Create Pickup Location - Saves Valid Mappings Only - Success")
  void createPickupLocation_SavesValidMappingsOnly_Success() {
    // Arrange
    testPickupLocationRequest.setProductMappings(
        List.of(
            new ProductPickupLocationMappingRequestModel(101L, 5),
            new ProductPickupLocationMappingRequestModel(102L, 0)));
    testPickupLocationRequest.setPackageMappings(
        List.of(
            new PackagePickupLocationMappingRequestModel(201L, 3, 1, 6),
            new PackagePickupLocationMappingRequestModel(202L, 0, 1, 2)));
    stubSuccessfulPickupLocationCreation();
    ...
    // Assert
    verify(productMappingRepository, times(1)).save(any());
    verify(packageMappingRepository, times(1)).save(any());
  }

  /**
   * Purpose: Reject ShipRocket response with invalid pickupId. Expected Result: BadRequestException
   * is thrown. Assertions: Error message matches ShipRocketPickupLocationIdInvalidFormat.
   */
  @Test
  @DisplayName("Create Pickup Location - Invalid ShipRocket Pickup Id - Throws BadRequestException")
  void createPickupLocation_InvalidShipRocketPickupId_ThrowsBadRequestException() {
    // Arrange
    AddPickupLocationResponseModel invalidResponse = new AddPickupLocationResponseModel();
    invalidResponse.setPickupId(0L);
    stubSuccessfulPickupLocationCreation();
    stubShipRocketHelperAddPickupLocation(invalidResponse);
    ...
    assertEquals(
        String.format(
            ErrorMessages.PickupLocationErrorMessages.SHIP_ROCKET_PICKUP_LOCATION_ID_INVALID_FORMAT,
            0L),
        ex.getMessage());
  }

  /**
   * Purpose: Verify private helper creates ShipRocketHelper when mock field is null. Expected
   * Result: A real ShipRocketHelper instance is returned. Assertions: Returned object is
   * ShipRocketHelper.
   */
  @Test
  @DisplayName("Create Pickup Location - Private Helper Creates ShipRocketHelper - Success")
  void createPickupLocation_PrivateHelperCreatesShipRocketHelper_Success() throws Exception {
    // Arrange
    ReflectionTestUtils.setField(pickupLocationService, "shipRocketHelper", null);
    ClientResponseModel client = new ClientResponseModel();
    client.setShipRocketEmail("helper@test.com");
    client.setShipRocketPassword("helper-pass");
    stubClientServiceGetClientById(TEST_CLIENT_ID, client);
    Method method = pickupLocationService.getClass().getDeclaredMethod("getShipRocketHelper");
    method.setAccessible(true);

    // Act
    Object helper = method.invoke(pickupLocationService);

    // Assert
    assertTrue(helper instanceof ShipRocketHelper);
  }

  /**
   * Purpose: Verify private helper with clientId creates ShipRocketHelper when mock field is null.
   * Expected Result: A real ShipRocketHelper instance is returned. Assertions: Returned object is
   * ShipRocketHelper.
   */
  @Test
  @DisplayName(
      "Create Pickup Location - Private Helper With ClientId Creates ShipRocketHelper - Success")
  void createPickupLocation_PrivateHelperWithClientIdCreatesShipRocketHelper_Success()
      throws Exception {
    // Arrange
    ReflectionTestUtils.setField(pickupLocationService, "shipRocketHelper", null);
    ClientResponseModel client = new ClientResponseModel();
    client.setShipRocketEmail("helper2@test.com");
    client.setShipRocketPassword("helper2-pass");
    stubClientServiceGetClientById(TEST_CLIENT_ID, client);
    Method method =
        pickupLocationService.getClass().getDeclaredMethod("getShipRocketHelper", Long.class);
    method.setAccessible(true);

    // Act
    Object helper = method.invoke(pickupLocationService, TEST_CLIENT_ID);
  ...
  /**
   * Purpose: Verify controller delegates createPickupLocation to service. Expected Result: Service
