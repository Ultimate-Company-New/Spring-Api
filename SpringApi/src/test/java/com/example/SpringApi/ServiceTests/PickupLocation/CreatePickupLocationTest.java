...
class CreatePickupLocationTest extends PickupLocationServiceTestBase {
     ...
     * Expected Result: Mapping repositories save only valid rows.
     * Assertions: Each mapping repository save is called once.
     */
    @Test
    ...
    void createPickupLocation_SavesValidMappingsOnly_Success() {
        // Arrange
        testPickupLocationRequest.setProductMappings(List.of(
                new ProductPickupLocationMappingRequestModel(101L, 5),
                new ProductPickupLocationMappingRequestModel(102L, 0)));
        testPickupLocationRequest.setPackageMappings(List.of(
    ...
    /**
     * Purpose: Reject ShipRocket response with invalid pickupId.
     * Expected Result: BadRequestException is thrown.
     * Assertions: Error message matches ShipRocketPickupLocationIdInvalidFormat.
     */
    @Test
    ...
    void createPickupLocation_InvalidShipRocketPickupId_ThrowsBadRequestException() {
        ...
        assertEquals(String.format(
                ErrorMessages.PickupLocationErrorMessages.SHIP_ROCKET_PICKUP_LOCATION_ID_INVALID_FORMAT, 0L),
                ex.getMessage());
    }

    /**
     * Purpose: Verify private helper creates ShipRocketHelper when mock field is null.
     * Expected Result: A real ShipRocketHelper instance is returned.
     * Assertions: Returned object is ShipRocketHelper.
     */
    @Test
     ...
     */
    @Test
    @DisplayName("Create Pickup Location - Private Helper With ClientId Creates ShipRocketHelper - Success")
    void createPickupLocation_PrivateHelperWithClientIdCreatesShipRocketHelper_Success() throws Exception {
        // Arrange
        ReflectionTestUtils.setField(pickupLocationService, "shipRocketHelper", null);
        ClientResponseModel client = new ClientResponseModel();
        ...
        stubClientServiceGetClientById(TEST_CLIENT_ID, client);
        Method method = pickupLocationService.getClass().getDeclaredMethod("getShipRocketHelper", Long.class);
        method.setAccessible(true);
